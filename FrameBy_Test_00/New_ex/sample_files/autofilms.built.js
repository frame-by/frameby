!function() {
    ...
    3: [function(t, e, i) {
        "use strict";
        var n, r = t("@marcom/ac-event-emitter-micro").EventEmitterMicro, o = t("./sharedRAFExecutorInstance"), s = t("./sharedRAFEmitterIDGeneratorInstance");
        function a(t) {
            t = t || {},
            r.call(this),
            this.id = s.getNewID(),
        ...
        var r = t("./utils/vector3FromLatLon")
          ...
          , A = function(t) {
            function e(t) {
                ...
                i._textureSrc = t.src,
                t.video ? i._videoElement = t.video : t.src instanceof HTMLVideoElement ? i._videoElement = t.src : i._textureSrc && (i._textureSrc.endsWith(".mp4") || i._textureSrc.endsWith(".m3u8") || i._textureSrc.endsWith(".webm")) && (i._videoElement = document.createElement("video")),
                i._maxLat = t.maxLat || b,
                i._pointerControls = new a({
                    el: t.mouseTarget || i.el
                }),
                i.arrowControls = new f,
                i._easing = t.easing || k,
                i._sineEasing = t.sineEasing || x,
                i._mapMinValue = void 0 !== t.mapMinValue ? t.mapMinValue : C,
                i._mapMaxValue = t.mapMaxValue || T,
                i._rotationDuration = t.rotationDuration || S,
                y && (i._orientationControls = new c),
                i._panVelocity = Object.assign({}, t.panVelocity || E),
                i._overshootMultiplier = t.overshootMultiplier || g,
                i._oscillationDuration = t.ocillationDuration || O,
                i._oscillationDistance = t.ocillationDistance || P,
                i._bindMethods();
            ...
            n(e, [{
                ...
                value: function() {
                    ...
                    this._orientationControls && (this._orientationControls.position = t);
                    var e = this.el.clientWidth
                      , i = this.el.clientHeight
                      , n = e / i;
                    this._camera = new THREE.PerspectiveCamera(75,n,1,1100),
                ...
                value: function(t) {
                    if (window.THREE) {
                        ...
                        this._camera.position.x = a,
                        this._camera.position.y = c,
                        ...
                        this._pointerControls.position = u,
                        this.arrowControls.position = u,
                        this._orientationControls && (this._orientationControls.position = u),
                        this._originQuaternion || (this._originQuaternion = (new THREE.Quaternion).copy(this._camera.quaternion)),
                        n && this.trigger(e.POSITION_CHANGE)
                    }
                }
            }, {
                key: "_createTexture",
                value: function(t) {
                    if (t instanceof HTMLVideoElement) {
                        ...
                        this._videoElement.addEventListener("playing", this._onPlaying);
                        var e = new THREE.VideoTexture(this._videoElement);
                        return e.minFilter = THREE.LinearFilter,
                    ...
                    return this._orientationControls.enable(),
                ...
                value: function() {
                    if (window.THREE && this._camera && this._renderer) {
                        var t = void 0
                          , e = void 0;
                        this._videoElement.parentElement ? (t = this._videoElement.clientWidth,
                        e = this._videoElement.clientHeight) : (t = this.el.clientWidth,
                ...
                value: function() {
                    ...
                    return this.trigger(e.ROTATION_START, o),
                    new Promise(function(s) {
                        d(n, function(n) {
                            ...
                            t._camera.position.copy(c),
                            t._camera.lookAt(t._camera.target),
                            t._camera.updateProjectionMatrix(),
                            t._renderer.render(t._scene, t._camera)
                        }).then(function() {
                            t.trigger(e.ROTATION_COMPLETE, o),
                            t.setPos(i.y, i.x),
                            t._animate(),
                            s()
                        })
                ...
                value: function(t) {
                    ...
                    t.lat === this.position.lat && t.lon === this.position.lon)
                        return this.trigger(e.ROTATION_START, {
                            time: 0,
                            startPosition: Object.assign({}, this.position),
                            targetPosition: Object.assign({}, this.position)
                        }),
                    ...
                    return this.trigger(e.ROTATION_START, f),
                    new Promise(function(o) {
                        d(h, function(t) {
                            ...
                            i._camera.position.copy(c),
                            i._camera.lookAt(i._camera.target),
                            i._camera.updateProjectionMatrix(),
                            i._renderer.render(i._scene, i._camera),
                            i.trigger(e.ROTATION_UPDATE, {
                                t: t,
                                easedVal: o,
                            ...
                            i.trigger(e.ROTATION_COMPLETE, f),
                            i.setPos(t.lat, t.lon),
                            i._animate(),
                            o()
                        })
                    }
          ...
          , l = function(t) {
            ...
            n(e, [{
                ...
                value: function() {
                    ...
                    this._lon = o(this._lon + this._velocity.x),
        ...
        var r = t("@marcom/ac-raf-emitter/update")
          ...
          , h = function() {
            function t() {
                ...
                this._horizontalFriction = e.friction && e.friction.x || a,
                this._verticalFriction = e.friction && e.friction.x || a,
                this._horizontalIncrement = e.acceleration && e.acceleration.x || c,
                this._verticalIncrement = e.acceleration && e.acceleration.y || c,
                this._minVelocity = e.minVelocity || l,
                this._maxVelocity = e.maxVelocity || u,
                this._velocity = {
                    x: 0,
                    y: 0
                },
            ...
            return n(t, [{
                ...
                value: function() {
                    ...
                    this._inertiaRaf = r(this._updateInertia)) : (this._velocity = {
                        x: 0,
                        y: 0
                    },
                    o(this._inertiaRaf),
        ...
        var r = t("../utils/normalizeLongitude")
          , o = function() {
            ...
            return n(t, [{
                ...
                key: "_onOrientation",
                value: function(t) {
                    window.matchMedia("(orientation: portrait)").matches ? (this._lon = r(this._lon - .02 * t.rotationRate.beta),
                    this._lat = this._lat - .02 * t.rotationRate.alpha) : t.orientation || -90 === window.orientation ? (this._lon = r(this._lon + .02 * t.rotationRate.alpha),
                    this._lat = this._lat - .02 * t.rotationRate.beta) : (this._lon = r(this._lon - .02 * t.rotationRate.alpha),
                    this._lat = this._lat + .02 * t.rotationRate.beta)
                }
            }, {
                key: "disable",
                value: function() {
        ...
        var r = t("../utils/normalizeLongitude")
          ...
          , a = function(t) {
            function e(t) {
                ...
                i._mouseDown = !1,
                i._scale = 1,
                i._hasInertia = !1 !== t.inertia || t.inertia,
                i._bindMethods(),
            ...
            n(e, [{
                ...
                value: function(t) {
                    ...
                    this._lastMouseDownLon = r(this._lon),
                ...
                value: function(t) {
                    if (this._mouseDown) {
                        ...
                        this._cachedPosition.clientX !== e.clientX || this._cachedPosition.clientY !== e.clientY) {
                            ...
                            if (this._cachedPosition) {
                                ...
                                this._velocity.x = Math.max(Math.min(a, this._maxVelocity), -this._maxVelocity),
                                this._velocity.y = Math.max(Math.min(c, this._maxVelocity), -this._maxVelocity)
                            }
                            this._lon = r(135 * o + this._lastMouseDownLon),
    ...
    21: [function(t, e, i) {
        ...
        e.exports = function(t) {
            var e = t;
            return e > 180 ? e = e % 180 - 180 : e <= -180 && (e = e % 180 + 180),
            e
        }
    }
    , {}],
    ...
    25: [function(t, e, i) {
        ...
        o.isFocusableElement = function(t, e, i) {
            return !(e && !this._isDisplayed(t)) && (n.nodeName[t.nodeName] ? !t.disabled : !t.contentEditable || (i = i || parseFloat(t.getAttribute("tabindex")),
            !isNaN(i)))
        }
        ,
        ...
        o.getTabbableElements = function(t, e) {
            for (var i = t.querySelectorAll(this.focusableSelectors), n = i.length, r = [], o = 0; o < n; o++)
    ...
    29: [function(t, e, i) {
        ...
        e.exports = function(t) {
            s(t, "tabindex"),
            s(t, r.HIDDEN);
            for (var e = t.querySelectorAll(`[${o + "tabindex"}]`), i = e.length; i--; )
                s(e[i], "tabindex")
        }
    }
    , {
    ...
    30: [function(t, e, i) {
        ...
        e.exports = function t(e, i) {
            i = i || document.body;
            for (var r = e, o = e; r = r.previousElementSibling; )
                n(r);
    ...
    40: [function(t, e, i) {
        "use strict";
        var n, r = t("@marcom/ac-object/extend"), o = t("@marcom/ac-object/create"), s = t("@marcom/ac-event-emitter-micro").EventEmitterMicro, a = t("@marcom/ac-dom-traversal/querySelectorAll"), c = t("@marcom/ac-dom-events/addEventListener"), l = t("@marcom/ac-dom-events/removeEventListener"), u = t("@marcom/ac-console");
        try {
        ...
        f.unbindEventListener = function() {
            for (var t = this.elements && this.elements.length ? this.elements.length : 0, e = 0; e < t; e++)
    ...
    50: [function(t, e, i) {
        ...
        e.exports = function(t) {
            return function() {
                if (n && "object" == typeof window.console && "function" == typeof console[t])
    ...
    53: [function(t, e, i) {
        "use strict";
        var n, r = t("ac-event-emitter").EventEmitter, o = t("./DOMEmitterEvent"), s = {
        ...
        n.has = function(t, e, i, n) {
            ...
            o = i) : (o = e,
            n = i),
            r ? this._getDelegateFuncBindingIdx(t, r, o, n, !0) > -1 : !(!this._eventEmitter || !this._eventEmitter.has.apply(this._eventEmitter, arguments))
        }
        ,
        n.trigger = function(t, e, i, n) {
            t = this._parseEventNames(t);
            var r, o, s, a = (t = this._cleanStringData(t)).length;
            for ("string" == typeof e ? (r = this._cleanStringData(e),
            o = i) : (o = e,
            i),
            s = 0; s < a; s++)
        ...
        n.emitterTrigger = function(t, e, i) {
            ...
            var n, r = t.length;
            for (n = 0; n < r; n++)
                this._eventEmitter.trigger(t[n], e, i);
            return this
        }
        ,
        ...
        n._unregisterDelegateFunc = function(t, e, i, n) {
            if (this._delegateFuncs[e] && this._delegateFuncs[e][t]) {
                ...
                return o > -1 && (r = this._delegateFuncs[e][t][o].delegateFunc,
        ...
        n._unbindDelegateFunc = function(t, e) {
            for (var i, n, r = 0; this._delegateFuncs[e][t] && this._delegateFuncs[e][t][r]; )
        ...
        n._on = function(t) {
            ...
            (e = this._parseEventNames(e)).forEach(function(t, e, i, n, r) {
                ...
                "string" == typeof n && (t = this._registerDelegateFunc(r, n, t, e, i)),
        ...
        n._off = function(t) {
            ...
            if (void 0 !== e)
                (e = this._parseEventNames(e)).forEach(function(t, e, i, n, r) {
                    ("string" != typeof n || "function" != typeof e || (t = this._unregisterDelegateFunc(r, n, e, i))) && ("string" != typeof n || void 0 !== t ? "string" == typeof r && void 0 === t && (this._unregisterDelegateFuncsByEvent(r),
        ...
        n._getDelegateFuncBindingIdx = function(t, e, i, n, r) {
            ...
            if (this._delegateFuncs[e] && this._delegateFuncs[e][t]) {
                ...
                for (s = 0; s < c; s++)
                    if (a = this._delegateFuncs[e][t][s],
                    r && void 0 === i && (i = a.func),
    ...
    64: [function(t, e, i) {
        ...
        e.exports = function(t, e, i, n) {
            return t.addEventListener ? t.addEventListener(e, i, !!n) : t.attachEvent("on" + e, i),
            t
        }
    }
    , {}],
    65: [function(t, e, i) {
        ...
        e.exports = function(t, e, i) {
            var n;
            return t.dispatchEvent ? (n = i ? new CustomEvent(e,i) : new CustomEvent(e),
            t.dispatchEvent(n)) : (n = document.createEventObject(),
    ...
    66: [function(t, e, i) {
        "use strict";
        e.exports = function(t, e, i, n) {
            return t.removeEventListener ? t.removeEventListener(e, i, !!n) : t.detachEvent("on" + e, i),
            t
        }
    }
    , {}],
    ...
    84: [function(t, e, i) {
        ...
        e.exports = function(t, e) {
            var i, r = t.parentNode || document, o = n(e, r);
    ...
    85: [function(t, e, i) {
        ...
        e.exports = function(t, e) {
            var i, n = document.createElement("style"), c = "_ac_qsa_" + (Math.random() + "").slice(-6), l = [];
            for (e = e || document,
            document[c] = [],
            r(e) ? e.appendChild(n) : document.documentElement.firstChild.appendChild(n),
            n.styleSheet.cssText = "*{display:recalc;}" + t + '{ac-qsa:expression(document["' + c + '"] && document["' + c + '"].push(this));}',
            a(e); document[c].length; )
    ...
    92: [function(t, e, i) {
        ...
        var n = "EventEmitter:propagation"
          ...
          , c = function(t, e) {
            ...
            if ((i = s.call(this)[t]) && 0 !== i.length)
                ...
                n = 0,
                r = i.length; n < r && (!this._stoppedImmediatePropagation && !e(i[n], n)); n++)
                    ;
        }
          , l = function(t, e, i) {
            var n = -1;
        ...
        o.has = function(t, e, i) {
            ...
            for (var o = 0, a = r.length; o < a; o++) {
                var c = r[o];
                if (i && e && c.context === i && c.callback === e)
                    return !0;
                if (e && !i && c.callback === e)
                    return !0
            }
    ...
    103: [function(t, e, i) {
        ...
        e.exports = {
            create: function() {
                var t = r;
                return "webkitEnterFullscreen"in document.createElement("video") && !("webkitRequestFullScreen"in document.createElement("div")) && (t = n),
                t
            }
        }
    }
    ...
    104: [function(t, e, i) {
        "use strict";
        var n, r = t("@marcom/ac-dom-events/addEventListener"), o = t("@marcom/ac-event-emitter-micro").EventEmitterMicro, s = t("./../events/types"), a = t("./../consts/modes");
        function c(t) {
            u.trigger(s.ENTERFULLSCREEN, t)
        }
        function l(t) {
            n = void 0,
            u.trigger(s.EXITFULLSCREEN, t)
        }
    ...
    114: [function(t, e, i) {
        ...
        d.close = function(t) {
            var e, i;
            if (this.opened) {
                if (t && "click" === t.type && (e = n.target(t),
        ...
        d._saveScrollPosition = function() {
            this._scrollX = r.getScrollX(),
            this._scrollY = r.getScrollY()
        }
        ,
        e.exports = h
    }
    ...
    115: [function(t, e, i) {
        ...
        var n = {
          ...
          , a = function(t) {
            ...
            this.options.classNames = r.defaults(s.classNames, t.classNames),
            this.options.dataAttributes = r.defaults(s.dataAttributes, t.dataAttributes),
        ...
        c.render = function() {
            ...
            !1 !== this.closeButton && (o.isElement(this.closeButton) || (this.closeButton = this.renderCloseButton(this.options.classNames.closeButton)),
    ...
    120: [function(t, e, i) {
        ...
        e.exports = function(t, e) {
            ...
            r.removeContainerPadding && i.modalElement.classList.add("remove-container-padding"),
            i
        }
    }
    , {
    ...
    123: [function(t, e, i) {
        ...
        var n = t("./extend")
          ...
          , o = function(t, e) {
            var i;
            for (i in e)
                r.call(e, i) && (null === e[i] ? t[i] = null : "object" == typeof e[i] ? (t[i] = Array.isArray(e[i]) ? [] : {},
                o(t[i], e[i])) : t[i] = e[i]);
            return t
        };
        e.exports = function(t, e) {
            ...
            if ("Element"in t) {
                ...
                c.add = function() {
                    ...
                    do {
                        ...
                        r = !0)
                    } while (++i < n);r && this._updateClassName()
                }
                ,
                c.remove = function() {
                ...
                i.defineProperty) {
                    ...
                    try {
                        ...
                        -2146823252 === t.number && (u.enumerable = !1,
                        i.defineProperty(e, "classList", u))
                    }
                } else
                    i.prototype.__defineGetter__ && e.__defineGetter__("classList", l)
            }
        }(self))
    }
    , {}],
    ...
    145: [function(t, e, i) {
        ...
        e.exports = function(t, e) {
            ...
            t in (i = n[e]) || "setAttribute"in i && (i.setAttribute(t, "return;"),
            "function" == typeof i[t])
        }
    }
    , {}],
    ...
    147: [function(t, e, i) {
        "use strict";
        var n, r = t("@marcom/ac-event-emitter-micro").EventEmitterMicro, o = t("@marcom/ac-raf-executor/sharedRAFExecutorInstance"), s = t("@marcom/ac-raf-emitter-id-generator/sharedRAFEmitterIDGeneratorInstance");
        function a(t) {
            t = t || {},
            r.call(this),
            this.id = s.getNewID(),
    ...
    158: [function(t, e, i) {
        ...
        a._setUpdateVars = function(t) {
            if (this._pushState && this._isPushStateSupported())
                t && this._hashChange && -1 !== window.location.href.indexOf("#") && this.history.pushState({}, document.title, window.location.href.replace("#", "")),
                this._hashChange = !1;
            else {
                if (t && this._pushState && this._hashChange && window.location.href.indexOf("#") < 0) {
                    ...
                    if (e.length)
                        return void (window.location = window.location.origin + this.root + "#" + e)
                }
        ...
        a._checkUrl = function() {
            ...
            0 === t.length && (t = "/"),
            this.fragment() !== t && (window.location.hash = "#" + t,
        ...
        a.navigate = function(t, e) {
            ...
            return this._pushState ? this.history.pushState(e, document.title, i) : this._hashChange && (this._ignoreHashChange = !0,
        ...
        a.fragment = function() {
            var t = "";
            return this._pushState ? t = window.location.pathname.substr(this.root.length) : this._hashChange && (t = window.location.hash.substr(1)),
            "" === t ? "/" : t
        }
        ,
        e.exports = s
    ...
    159: [function(t, e, i) {
        ...
        var n = t("@marcom/ac-object").create
          ...
          , o = t("./History")
          , s = (t("@marcom/ac-routes").Route,
        t("@marcom/ac-routes").Routes);
        function a(t) {
            t = t || {},
            ...
            t.autoStart && (this.history.started || this.history.start(),
            this.start())
        }
        ...
        c._handleTrigger = function(t) {
            if (this.started) {
                ...
                e && (/^(http|https):\/\/+/.exec(e) && "href" === this._interceptAttribute && (e = e.substr(e.indexOf(this.history.root) + this.history.root.length) || "/"),
        ...
        c.navigate = function(t, e) {
            return this.history.fragment() !== t || e ? !(t && !e && !this.history.navigate(t)) && (this.match(t),
    ...
    162: [function(t, e, i) {
        ...
        o._getIndex = function(t, e, i) {
            if (void 0 !== this._routes[t])
                for (var n = this._routes[t].length; --n > -1; )
                    if (this._routes[t][n].callback === e && this._routes[t][n].context === i)
                        return n;
            return -1
        }
        ,
        ...
        ,
        o.add = function(t) {
            if (void 0 === this._routes[t.path])
                this._routes[t.path] = [t];
                ...
                if (i > 0)
                    for (e = 0; e < i; ++e)
                        if (this._routes[t.path][e].priority > t.priority)
                            return this._routes[t.path].splice(e, 0, t),
                            t;
        ...
        o.remove = function(t) {
            ...
            return e > -1 && (this._routes[t.path].splice(e, 1),
            t)
        }
        ,
    ...
    164: [function(t, e, i) {
        "use strict";
        var n, r = window, o = r.AC, s = (n = {},
        {
            get: function(t, e) {
                var i = null;
                return n[t] && n[t][e] && (i = n[t][e]),
                i
            },
            set: function(t, e, i) {
                return n[t] || (n[t] = {}),
    ...
    165: [function(t, e, i) {
        ...
        _._addEventListeners = function() {
            ...
            this._keyboard && ("horizontal" === this.model.orientation ? (this._keyboard.onDown(l.num, this.stepUp),
        ...
        _._getNextValue = function(t, e, i, n) {
            return t = this._correctValueMinMax(t, e, i),
        ...
        _.getClientValue = function(t) {
            ...
            "horizontal" === this.model.orientation ? this.getClientXValue(t) : this.getClientYValue(t)
        }
        ,
        ...
        _._onChange = function(t) {
            ...
            isNaN(e) || ("horizontal" === this.getOrientation() ? this.thumbElement.style.left = e + "%" : this.thumbElement.style.bottom = e + "%",
        ...
        _._step = function(t, e) {
            ...
            i ? Math.abs(this._keyDown[d(t)]) < Math.abs(this.model.max * this.model.keyboardMaxStepPercentage) && (i *= this.model.keyboardStepMultiplier) : (this.trigger("grab", this.getValue()),
        ...
        _.setValue = function(t) {
            t = this._getNextValue(t, this.getMin(), this.getMax(), this.getStep()),
            this._set("value", t),
        ...
        _.setMin = function(t) {
            this._set("min", t),
            this.el.setAttribute("aria-valuemin", t)
        }
        ,
        _.setMax = function(t) {
            this._set("max", t),
        ...
        _._removeEventListeners = function() {
            ...
            this._removeEventListener(document, "touchend", this._onMouseUp),
            "horizontal" === this.model.orientation ? (this._keyboard.offDown(l.num, this.stepUp),
            this._keyboard.offDown(a.num, this.stepDown),
            this._keyboard.offUp(a.num, this._triggerRelease),
            this._keyboard.offUp(l.num, this._triggerRelease)) : (this._keyboard.offDown(u.num, this.stepDown),
    ...
    170: [function(t, e, i) {
          ...
          , r = {
            ...
            parseObject: function(t, e, i) {
                ...
                var n = t.shift()
                  , o = {};
                if ("[]" === n)
                    o = (o = []).concat(r.parseObject(t, e, i));
                else {
            ...
            parseKeys: function(t, e, i) {
                if (t) {
                    ...
                    if (!Object.prototype.hasOwnProperty(o[1])) {
                        var s = [];
                        o[1] && s.push(o[1]);
                        for (var a = 0; null !== (o = n.exec(t)) && a < i.depth; )
                            ++a,
                            Object.prototype.hasOwnProperty(o[1].replace(/\[|\]/g, "")) || s.push(o[1]);
                        return o && s.push("[" + t.slice(o.index) + "]"),
                        r.parseObject(s, e, i)
                    }
                }
            }
        ...
        e.exports = function(t, e) {
            if ("" === t || null === t || void 0 === t)
                return {};
            (e = e || {}).delimiter = "string" == typeof e.delimiter || n.isRegExp(e.delimiter) ? e.delimiter : r.delimiter,
            e.depth = "number" == typeof e.depth ? e.depth : r.depth,
            e.arrayLimit = "number" == typeof e.arrayLimit ? e.arrayLimit : r.arrayLimit,
            e.parameterLimit = "number" == typeof e.parameterLimit ? e.parameterLimit : r.parameterLimit;
        ...
        var n = t("./utils")
          , r = {
            ...
            stringify: function(t, e, i) {
                if (n.isBuffer(t) ? t = t.toString() : t instanceof Date ? t = t.toISOString() : null === t && (t = ""),
    ...
    172: [function(t, e, i) {
        ...
        i.merge = function(t, e) {
            if (!e)
                return t;
            if ("object" != typeof e)
                return Array.isArray(t) ? t.push(e) : t[e] = !0,
                t;
            if ("object" != typeof t)
                return t = [t].concat(e);
    ...
    174: [function(t, e, i) {
        ...
        function r() {
            ...
            for (t in this.types = {},
            n)
                n.hasOwnProperty(t) && (o[t] = t,
                this.addType(t, n[t].getDialogDebugData.bind(n[t])))
        }
        var o = r.prototype;
    ...
    175: [function(t, e, i) {
        ...
        function r() {
            ...
            n)
                n.hasOwnProperty(t) && (o[t] = t,
                this.addType(t, n[t].generateDialog.bind(n[t])))
        }
        var o = r.prototype;
        o.create = function(t, e) {
            e = e || {};
    ...
    177: [function(t, e, i) {
        ...
        function o() {
            ...
            for (t in this.types = {},
            n)
                n.hasOwnProperty(t) && (s[t] = t,
                this.addType(t, n[t].generateLink.bind(n[t])))
        }
        var s = o.prototype;
    ...
    180: [function(t, e, i) {
        ...
        e.exports = new n(function(t) {
            ...
            return t.title && (e.subject = t.title),
            t.description ? e.body = t.description + "\r\n\r\n" + t.url : e.body = t.url,
            e
        }
        ,{
            id: "email-share",
    ...
    182: [function(t, e, i) {
        "use strict";
        var n, r = t("qs"), o = function(t, e) {
            e = e || {},
            this.baseLinkPath = e.baseLinkPath,
            e.dialogDimensions && (this.dialogDimensions = e.dialogDimensions),
            e.id && (this.id = e.id),
            e.preventDialog && (this.preventDialog = e.preventDialog),
            this.normalizeData = t
        };
        (n = o.prototype).dataAttributeName = "network-action",
        n.id = "network-action",
        ...
        n.generateLink = function(t, e) {
            ...
            return (e = e || document.createElement("A")).setAttribute("href", i),
    ...
    183: [function(t, e, i) {
        ...
        e.exports = new n(function(t) {
            ...
            return t.media && (e.media = t.media),
            e
        }
        ,{
            id: "pinterest-share",
    ...
    187: [function(t, e, i) {
        ...
        e.exports = new n(function(t) {
            ...
            return t.media && (e.source = t.media),
            e
        }
        ,{
            id: "tumblr-share",
    ...
    189: [function(t, e, i) {
        ...
        e.exports = new n(function(t) {
            ...
            return t.hashtags && (e.hashtags = t.hashtags),
            e
        }
        ,{
            id: "twitter-reply",
    ...
    198: [function(t, e, i) {
        ...
        function s(t, e, i) {
            for (var n, r, s = t.length, a = 0; a < s; a++)
                if ("function" == typeof t[a].test ? !0 === t[a].test(i) && (n = t[a].name) : i.ua.indexOf(t[a].userAgent) > -1 && (n = t[a].name),
                n) {
                    if (e[n] = !0,
                    "string" == typeof (r = o(t[a], i.ua))) {
                        var c = r.split(".");
                        e.version.name = r,
        ...
        e.exports = function(t) {
            var e = {};
            return e.browser = s(r.browser, n.browser, t),
            e.os = s(r.os, n.os, t),
            e
        }
    }
        ...
        var r = t("@marcom/ac-event-emitter-micro").EventEmitterMicro
          , o = function(t) {
            function e(t) {
                ...
                return i._chapters = Array.from(t.chapters || []),
                i
            }
            return function(t, e) {
                if ("function" != typeof e && null !== e)
                    ...
                    for (var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, i = 0; i < this._chapters.length; i++) {
                        ...
                        if (!n.duration || isNaN(n.duration)) {
                            if (this._chapters.length > i + 1) {
                                ...
                                if (t >= r - e && t < o["start-time"] - e)
                                    return n
                            } else if (t >= r)
                                return n
                        } else if (r - e <= t && t < r + n.duration - e)
                            return n
                    }
                    return null
                }
            ...
            n(e, [{
                ...
                value: function(t, i, n) {
                    if (n) {
                        ...
                        r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "once", this).apply(this, arguments)
                }
            }, {
                key: "on",
                value: function(t, i, n) {
                    if (arguments.length > 2) {
                        ...
                        this._boundListeners[t] || (this._boundListeners[t] = []);
                        var o = i.bind(n);
                        return this._boundListeners[t].push([i, n, o]),
                        r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "on", this).call(this, t, o)
                    }
    ...
    204: [function(t, e, i) {
        ...
        var F = function(t) {
            function e(t) {
                ...
                t = t || {},
                i.el = t.el || document.createElement("div"),
                i._elementEmitter = new s(i.el),
                i.VERSION = D,
                i.options = t,
                i._controlsFactory = t.controlsFactory,
                i._urlOptimizer = t.urlOptimizer,
                g && i.el.classList.add("safari-fix-zindex");
                try {
                    var n = window.top;
                ...
                return i._lastResize = 0,
                i._lastMouseCoords = {},
                i.el.classList.add("ac-video-player"),
                i.el.classList.add("idle-state"),
                i._isLive = t.live,
                i._isDvr = t.dvr,
                i._isLive && i._useLiveMode(t.dvr),
                i._videoImpl = c(t, i.el),
                i._isResponsive = t.responsive,
                i._isResponsive && (i._breakpointDetect = new S({
                    el: i.el,
                    player: i,
                    breakpoints: k,
                    addClass: !0
                })),
                i._supportsInlineVideo = v || !(y && b),
                i._cachedPiPMode = i.isPictureInPicture(),
                i._cachedReadyState = i.getReadyState(),
                i._cachedVisibleTracksLength = 0,
                i.el.appendChild(i._videoImpl.getRenderElement()),
                (t.poster || void 0 === t.poster) && (i._initPoster(t.poster),
                t.autoplay || void 0 === t.preload || "none" !== t.preload && "metadata" !== t.preload && !1 !== t.preload || i._poster.show()),
                i._bindMethods(),
                i._addEventListeners(),
                v && (i._keyboardControl = O({
                    player: i,
                    threesixty: t.threesixty,
                    keyboardTarget: t.keyboardTarget
                })),
                t.controls && i._initUIComponents(),
                i._initErrorView(),
                t.parentElement && t.parentElement.appendChild(i.el),
                i._chapterEmitter = new a(t),
                i.refreshSize = i.refreshSize.bind(i),
                i._refreshSizeTimeout = setTimeout(i.refreshSize, 0),
                window.addEventListener("DOMContentLoaded", i.refreshSize),
                i
            }
            return function(t, e) {
                if ("function" != typeof e && null !== e)
            ...
            r(e, [{
                ...
                value: function() {
                    for (var t = 0, e = C.length; t < e; t++)
                        this._videoImpl.on(C[t], this._forwardEvent);
                    for (t = 0,
                    e = T.length; t < e; t++)
                        this._videoImpl.on(T[t], this._forwardReadyStateChange);
                    ...
                    v ? (u.on("enterfullscreen", this._forwardEnterFullScreenEvent),
                    u.on("exitfullscreen", this._forwardExitFullScreenEvent),
                    u.on("enterfullscreen", this._forwardFullScreenChangeEvent),
                    u.on("exitfullscreen", this._forwardFullScreenChangeEvent),
                    this.on("fullscreen:change", this._onFullscreenChange)) : b && (this._videoImpl.on("webkitbeginfullscreen", this._forwardEnterFullScreenEvent),
                    ...
                    y && this.on("fullscreen:change", this._onFullscreenChange)),
                ...
                value: function() {
                    for (var t = 0, e = C.length; t < e; t++)
                        this._videoImpl.off(C[t], this._forwardEvent);
                    for (t = 0,
                    e = T.length; t < e; t++)
                        this._videoImpl.off(T[t], this._forwardReadyStateChange);
                    ...
                    v ? (u.off("enterfullscreen", this._forwardEnterFullScreenEvent),
                    u.off("exitfullscreen", this._forwardExitFullScreenEvent),
                    u.off("enterfullscreen", this._forwardFullScreenChangeEvent),
                    u.off("exitfullscreen", this._forwardFullScreenChangeEvent)) : l.os.ios && (this._videoImpl.off("webkitbeginfullscreen", this._forwardEnterFullScreenEvent),
                ...
                value: function() {
                    ...
                    (t > this._cachedReadyState || 0 === t) && (this._cachedReadyState = t,
                ...
                key: "_forwardEvent",
                value: function(t) {
                    x(t.type + " time:" + this.getCurrentTime()),
                    this.trigger(t.type)
                }
            }, {
                key: "_forwardNamedEvent",
                value: function(t) {
                    x(t + " time:" + this.getCurrentTime()),
                    this.trigger(t)
                }
            }, {
                key: "_onPlayPromiseError",
                value: function() {
                    x("play() Promise rejected, probably because the browser is blocking autoplay"),
                ...
                value: function(t) {
                    ...
                    e > 0 && 0 === this._cachedVisibleTracksLength ? this.trigger("texttrackshow") : 0 === e && this._cachedVisibleTracksLength > 0 && this.trigger("texttrackhide"),
                    this._cachedVisibleTracksLength = e
                }
            }, {
                key: "_onTimeUpdate",
                value: function() {
                ...
                value: function(t, e, i, n) {
                    ...
                    this.once("play", this._onPlay),
                    (this.options.autoplay && v || this.getEnded()) && this.once("loadstart", function() {
                        this.play()
                    }
                    .bind(this)),
                    n || (n = this.options),
                ...
                value: function(t) {
                    for (; t !== this.el; ) {
                        if (t.hasAttribute("data-acv-active-area"))
                            return !0;
                        t = t.parentNode
                    }
                    return !1
                ...
                value: function(t) {
                    ...
                    this._cachedPiPMode !== e && (this._cachedPiPMode = e,
                    x("pictureinpicture:change to " + e),
                ...
                value: function() {
                    if (!this.isFullscreen()) {
                        ...
                        m(this._updateFullscreenId);
                        var t = this;
                        this._updateFullscreenId = f(function e() {
                            t.refreshSize(),
                            t._updateFullscreenId = f(e)
                        }),
                        w ? setTimeout(function() {
                            this._lastResize = Date.now(),
                            u.requestFullscreen(this.getFullScreenElement())
                        }
                ...
                value: function() {
                    ...
                    v ? this.el.appendChild(this._blockade.el) : (this.controls.el.classList.add("mobile"),
                ...
                key: "_createBlockade",
                value: function() {
                    this._blockade = new s(document.createElement("div")),
                ...
                key: "_onPlay",
                value: function() {
                    this._started || (this.el.classList.remove("idle-state"),
                    this.once("timeupdate", this._onStart, function() {
                ...
                value: function(t) {
                    ...
                    t && !E && this.el.classList.add("ac-video-live-dvr")) : (this.el.classList.remove("ac-video-live"),
                    this.el.classList.remove("ac-video-live-dvr"))
                }
            }, {
                key: "once",
                value: function(t, i, r) {
                    if (arguments.length < 3 || "object" === (void 0 === r ? "undefined" : n(r)))
                        (function t(e, i, n) {
                            null === e && (e = Function.prototype);
                            var r = Object.getOwnPropertyDescriptor(e, i);
                            if (void 0 === r) {
                ...
                value: function() {
                    ...
                    x("play called"),
                    !this._videoImpl.getError() || 0 !== e && !isNaN(e) ? this._videoImpl.play() : setTimeout(function() {
                        t._errorView.focus()
                    }, 1e3)
                }
            }, {
                ...
                value: function() {
                    ...
                    this._currentBreakpoint = S.getBreakpointFromElement(this.el, k),
                    this.el.classList.add(this._currentBreakpoint.name)),
                    this._videoImpl.refreshSize()
                }
            }, {
                key: "_setError",
                value: function(t) {
                ...
                value: function(t) {
                    ...
                    if (this._started)
                        x("ERROR: an error occured during playback, but we'll try to recover. Error code " + (e ? e.message : "unknown"));
                    ...
                    this.controls) {
                        ...
                        if (t.message)
                            ...
                            if (!d.translationReady())
                                return void d.getTranslation({
        ...
        var o = t("./Player")
          ...
          , l = function(t) {
            function e(t) {
                ...
                return t.threesixty && i.el.classList.add("threesixty-video"),
                i
            }
            return function(t, e) {
                if ("function" != typeof e && null !== e)
            ...
            n(e, [{
                key: "_bindMethods",
                value: function() {
                    r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_bindMethods", this).call(this),
                ...
                key: "_removeEventListeners",
                value: function() {
                    r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_removeEventListeners", this).call(this),
    ...
    208: [function(t, e, i) {
        ...
        e.exports = function(e) {
            var i;
            (e ? arguments.length > 1 && (e = Object.assign.apply(null, Array.prototype.slice.apply(arguments))) : e = {},
            e.components || (e.components = t("../../ui/DefaultComponents")),
            void 0 === e.controls && (e.controls = !0),
            e.controlsImplementation || (e.controlsImplementation = t("../../ui/ControlBar")),
            e.controlsFactory || (e.controlsFactory = t("../../ui/ControlsFactory")({
                controlsImplementation: e.controlsImplementation,
                components: e.components,
                template: e.controlsTemplate
            })),
            (void 0 !== e.urlOptimizer && !0 === e.urlOptimizer || "true" === e.urlOptimizer) && (e.urlOptimizer = t("../../optimizeVideoUrl")),
            e.sources || e.src ? e.sources || (e.sources = e.src ? [e.src] : []) : e.sources = [],
            e.autoplay = void 0 !== e.autoplay ? e.autoplay : n,
            e.controlsTimeoutDuration || (e.controlsTimeoutDuration = 3e3),
            e.threesixty) ? (e.threesixtyElementsTimeoutDuration || (e.threesixtyElementsTimeoutDuration = 3e3),
            i = new (t("../ThreeSixtyPlayer"))(e)) : i = new (t("../Player"))(e);
            var r = {};
            return e.sharing && (r.sharing = Object.assign({}, e.sharing)),
            e.thumbnails && (r.thumbnails = Object.assign({}, e.thumbnails)),
            e.endState && (r.endState = Object.assign({}, e.endState)),
            e.sources && e.sources.length && (e.autoplay || !e.preload || "auto" === e.preload || !0 === e.preload ? i.load(e.sources, e.textTracks, e.startTime, r) : i.setSrc(e.sources[0])),
            i
        }
    }
    , {
        ...
        var r = function() {
            ...
            return n(t, [{
                ...
                value: function(t) {
                    ...
                    e !== this._currentSrc && (this._imgElement.style.display = "none",
          ...
          , a = function() {
            ...
            return n(t, [{
                ...
                value: function() {
                    ...
                    t.length ? (this._activeTrack = t[0],
                ...
                value: function(t) {
                    ...
                    if (!e)
                        return "";
                    if (this._currentCaption && this._currentCaption.startTime >= t && this._currentCaption <= t)
                        return this._currentCaption.text;
                    for (var i = 0, n = e.length, r = void 0; i < n; ) {
                        if (e[i].startTime <= t && e[i].endTime >= t)
                            r = e[i];
                        else if (e[i].startTime >= t)
                            break;
                        i++
                    }
        ...
        var o = t("../ui/factory/createComponents")
          ...
          , u = function(t) {
            function e(t) {
                ...
                return i.container = t.container,
                i._video = t.video,
                i._initialize(t),
                i
            }
            ...
            n(e, [{
                ...
                value: function(t) {
                    ...
                    this.el.innerHTML = t.template || '<div class="ac-video-player-text-track"></div>',
    ...
    214: [function(t, e, i) {
        ...
        var o = function(t) {
            ...
            if (t instanceof HTMLElement)
                ...
                i.kind = "captions",
                i.srclang = t.srclang,
                "en" === i.srclang ? i.label = t.label || "English" : i.label = t.label || t.srclang && t.srclang.toUpperCase() || "Unknown CC",
                r.browser.firefox ? (e = this.el.textTracks.length,
                setTimeout(function() {
                    this.el.appendChild(i),
                    n(this.el.textTracks[e], t.mode || "hidden")
                }
                .bind(this), 0)) : r.os.android ? (e = this.el.textTracks.length,
                this.el.appendChild(i),
                n(this.el.textTracks[e], t.mode || "hidden")) : (this.el.appendChild(i),
                n(i, t.mode || "hidden"))
            }
        };
        e.exports = {
    ...
    216: [function(t, e, i) {
        ...
        e.exports = function(e) {
            var i;
            return i = !!(e = e || {}).hls || !e.threesixty && (void 0 === e.useNativeCaptions ? r : e.useNativeCaptions),
    ...
    217: [function(t, e, i) {
        ...
        e.exports = function(t) {
            ...
            return t.filter(function(t) {
                return !(e.has(t.label) || "subtitles" !== t.kind && "captions" !== t.kind && t.kind) && (e.add(t.label),
                !0)
            })
        }
    }
    ...
    218: [function(t, e, i) {
        ...
        e.exports = function(t) {
            for (var e, i, r = t.split(/\n/), o = /([\d]{2}:)?[\d]{2}:[\d]{2}.[\d]{3}( --> ){1}([\d]{2}:)?[\d]{2}:[\d]{2}.[\d]{3}/, s = [], a = 0, c = r.length; a < c; a++)
                if (i = "",
                o.test(r[a])) {
                    for ((e = r[a].split(" --\x3e "))[0] = e[0].split(":").length < 3 ? "00:" + e[0] : e[0],
                    e[1] = e[1].split(":").length < 3 ? "00:" + e[1] : e[1]; ++a && a < c && !o.test(r[a]); )
                        "" !== r[a] && (i += r[a] + "<br />");
    ...
    219: [function(t, e, i) {
        ...
        m._initUIComponents = function(t) {
            ...
            n && (t.enableMainControls ? (n.classList.add("control-bar-skin-default"),
            ...
            t.threesixty && (this.compass = new u({
                rootElement: e,
                player: this._player
            })),
            ...
            a && t.enableMainControls && (this.overlays = new c({
        ...
        e.exports = function(t) {
            ...
            return {
                create: function(i) {
                    ...
                    return r.components = t.components || n.components,
        ...
        var r = t("./ButtonBehavior")
          , o = function(t) {
            function e(t, i) {
                ...
                return n._player.supportsAirPlay() && (n._airplayStateChange = n._airplayStateChange.bind(n),
                n._player.getMediaElement().addEventListener("webkitplaybacktargetavailabilitychanged", n._airplayStateChange),
                n._updateState = n._updateState.bind(n),
                n._player.getMediaElement().addEventListener("webkitcurrentplaybacktargetiswirelesschanged", n._updateState)),
                n
            }
            return function(t, e) {
                if ("function" != typeof e && null !== e)
            ...
            n(e, [{
                ...
                value: function(t) {
                    "available" === t.availability ? this._airplayAvailable = !0 : this._airplayAvailable = !1,
                    this._updateState()
                }
            }, {
                key: "_updateState",
        ...
        var r = t("./ButtonBehavior")
          ...
          , s = function(t) {
            function e(t, i) {
                ...
                n._allowMultiLanguageCaptions = !n._player.options.disableMultiLanguageCaptions,
                n
            }
            return function(t, e) {
                if ("function" != typeof e && null !== e)
            ...
            n(e, [{
                ...
                value: function() {
                    var t = this._player.getVisibleTextTracks()
                      , e = o(this._player.getTextTracks());
                    e.length > 1 && this._allowMultiLanguageCaptions ? this._player.isCaptionsSelectorShowing() ? this._player.hideCaptionsSelector() : this._player.showCaptionsSelector() : 1 === t.length ? e[0].mode = "hidden" : e[0].mode = "showing",
          ...
          , u = function(t) {
            ...
            n(e, [{
                ...
                value: function(t) {
                    ...
                    e.language !== r && (e.mode = "showing"),
                    a && this._player.getMediaElement().textTracks.dispatchEvent(new CustomEvent("change")),
                    setTimeout(this._updateState)
                }
            }, {
                key: "destroy",
        ...
        var r = t("./ButtonBehavior")
          , o = function(t) {
            function e(t, i) {
                ...
                return n._player.getFullScreenEnabled() && n._updateState(),
                n
            }
            return function(t, e) {
                if ("function" != typeof e && null !== e)
        ...
        var r = t("./ButtonBehavior")
          ...
          , s = function(t) {
            function e(t, i) {
                ...
                return n._updateState = n._updateState.bind(n),
          ...
          , s = function(t) {
            ...
            n(e, [{
                ...
                value: function() {
                    ...
                    r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_initialize", this).call(this)
                }
            }, {
                key: "_onClick",
                value: function() {
        ...
        var r = t("./BaseBehavior")
          ...
          , l = function(t) {
            function e(t, i) {
                ...
                return n._player.isDvr() ? n._liveStreamLookback = c : n._liveStreamLookback = 0,
                n._visible = !1,
            ...
            n(e, [{
                ...
                value: function() {
                    ...
                    this._player.isLive() || (a(this._timeUpdateInterval),
                ...
                value: function(t) {
                    ...
                    this._player.controls.overlays.setPopUpPosition(t["start-time"])
                }
            }, {
                ...
                key: "_getDuration",
                value: function() {
                    return this._cachedDuration && isNaN(this._cachedDuration) || (this._cachedDuration = Math.max(0, this._player.getDuration() - this._liveStreamLookback)),
                ...
                key: "_onDurationChange",
                value: function() {
                    this._cachedDuration = Math.max(0, this._player.getDuration() - this._liveStreamLookback),
        ...
        var r = t("./ButtonBehavior")
          , o = function(t) {
            function e(t, i) {
                ...
                return n._player.states && n._updateState(),
                n
            }
            return function(t, e) {
                if ("function" != typeof e && null !== e)
        ...
        var r = t("./BaseBehavior")
          , o = function(t) {
            function e(t, i) {
                ...
                return n._hideVolume(),
                n._updateSliderVolumeValue(),
                n
            }
            return function(t, e) {
                if ("function" != typeof e && null !== e)
            ...
            n(e, [{
                ...
                value: function() {
                    var t = this._view.getValue();
                    this._setPlayerVolume(t),
                    this._view.setScrubbedValue()
                }
            }, {
                key: "_setPlayerVolume",
                value: function(t) {
                    t ? (this._player.setMuted(!1),
                    this._player.setVolume(t / 100)) : (this._player.setMuted(!0),
          ...
          , c = function() {
            ...
            return n(t, [{
                ...
                value: function(t) {
                    ...
                    this.compassRing.style.transition = "transform " + e + "ms cubic-bezier(0.25,0.1,0,1)",
                    this.compassField.style.transition = "transform " + e + "ms cubic-bezier(0.25,0.1,0,1)";
                ...
                value: function(t) {
                    ...
                    this.compassRing.style.transform = "rotate(" + t.currentPosition.lon + "deg)",
                    this.compassField.style.transition = "transform 0.1s ease",
                    this.compassField.style.transform = "rotate(" + t.currentPosition.lon + "deg)"
                }
            }, {
                key: "_onCompassClick",
                value: function(t) {
                ...
                value: function() {
                    ...
                    this.compassField.style.transform = t > 180 ? "rotate(360deg)" : t < -180 ? "rotate(-360deg)" : "rotate(0deg)"
                }
            }, {
                ...
                value: function() {
                    ...
                    this.compassRing.style.transform = "rotate(" + t + "deg)",
    ...
    239: [function(t, e, i) {
        ...
        var r = function() {
            ...
            return n(t, [{
                ...
                value: function(t, e) {
                    !t || "click" !== t.type && "focusin" !== t.type || this._player.isCaptionsSelectorShowing() && !t.target.classList.contains("controls-text-tracks-toggle-button") && "radio" !== t.target.getAttribute("role") && "radiogroup" !== t.target.getAttribute("role") && this._player.hideCaptionsSelector(),
                    !this._player.getCurrentSrc() || this._preventUserInteraction || !e && t && "mousemove" === t.type && this._lastMouseCoords.x === t.screenX && this._lastMouseCoords.y === t.screenY || (t && t.pageX && (this._lastMouseCoords = {
                        x: t.screenX,
                        y: t.screenY
                    }),
                    this._showControls(),
                    ...
                    this._shouldIgnoreUserInteraction(t) || (this._userInteractionTimeout = window.setTimeout(this._onUserInteractionTimeout, this._controlsTimeoutDuration)))
                }
            }, {
                ...
                value: function() {
                    ...
                    this._fullscreenChangeTimeout = setTimeout(function() {
                        t._preventUserInteraction = !1,
                        t._player.refreshSize()
                    }, 750),
                ...
                value: function(t) {
                    ...
                    this._focusOutTimer = setTimeout(function() {
                        e._hasFocus && !e.el.contains(document.activeElement) && (e._hasFocus = !1,
                        e._hideControls(),
                        e._lowerControls())
                    }, 100)
                }
        ...
        var o = t("./DefaultControlsInteraction")
          ...
          , c = function(t) {
            function e(t) {
                ...
                return i._showCompass = t.showCompass,
                i._hideCompass = t.hideCompass,
                i._threesixtyElementsTimeoutDuration = t.threesixtyElementsTimeoutDuration || a,
            ...
            n(e, [{
                ...
                key: "_onUserInteraction",
                value: function(t) {
                    this._userWasRecentlyDragging || t && "mousemove" === t.type && this._lastMouseCoords.x === t.screenX && this._lastMouseCoords.y === t.screenY || this._dragging || (this._showCompass(),
                    clearTimeout(this._userHideMouse),
                    r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_onUserInteraction", this).call(this))
                }
            }, {
                key: "_onUserInteractionTimeout",
                value: function() {
                    var t = this;
                    r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_onUserInteractionTimeout", this).call(this),
                    clearTimeout(this._userHideMouse),
                ...
                value: function(t) {
                    var e = this;
                    !this._dragging && this._isActiveArea(t.target) || (this._dragging = !0,
                ...
                key: "_onMouseDown",
                value: function(t) {
                    this._isActiveArea(t.target) && this._controlsVisible() && !this._isDraggable(t.target) || !this._isPlayingState() || (this._showControls(),
                    clearTimeout(this._userHideMouse),
                ...
                key: "_onMouseLeave",
                value: function(t) {
                    r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_onMouseLeave", this).call(this),
                ...
                key: "_onClick",
                value: function(t) {
                    this._player.controls.compass.el.contains(t.target) && this._userWasRecentlyDragging && t.stopPropagation(),
                    t.target !== this._player.controls.playButtonElement.parentElement && t.target !== this._controls.el.firstElementChild || null === this._mouseDownPosition || this._mouseDownPosition.x !== t.x || this._mouseDownPosition.y !== t.y || (this._mouseDownPosition = null,
        ...
        var o = t("./ThreeSixtyControlsInteraction")
          , s = function(t) {
            function e(t) {
                ...
                return i._controlsVisible = t.controlsVisible,
                i
            }
            return function(t, e) {
                if ("function" != typeof e && null !== e)
            ...
            n(e, [{
                ...
                key: "_onClick",
                value: function(t) {
                    t.target !== this._player.controls.compass.compassView && (this._controlsVisible() ? this._isActiveArea(t.target) || (this._hideControls(),
                    this._hideCompass()) : this._onUserInteraction(t))
                }
            }, {
                key: "_onTouchStart",
                value: function(t) {
                    t.target !== this._player.controls.playButtonElement && t.target !== this._controls.el.firstElementChild && t.target !== this._player.controls.compass.compassView && t.target !== this._player.controls.playButtonElement || (document.addEventListener("touchend", this._onTouchEnd),
            ...
            n(e, [{
                ...
                value: function(t) {
                    ...
                    t.forEach(function(t) {
                        ...
                        "showing" === t.mode ? (n.classList.add(t.mode),
                ...
                value: function(t) {
                    var e = t.target
                      , i = !1;
                    parseInt(t.keyCode) === s.ARROW_DOWN ? i = e.nextSibling : parseInt(t.keyCode) === s.ARROW_UP && (i = e.previousSibling),
    ...
    247: [function(t, e, i) {
        ...
        var n = t("@marcom/ac-slider").Slider
          ...
          , o = function(t, e) {
            ...
            this._axTrack && (this._axTrack.tabIndex = 0,
        ...
        s.setValue = function(t) {
            return this._axTrack && this._axTrack.setAttribute("aria-valuenow", t),
        ...
        s.setMin = function(t) {
            this._min = t,
            this._slider.setMin(t)
        }
        ,
        s.setMax = function(t) {
            this._max = t,
            this._slider.setMax(t)
        }
        ,
        ...
        var r = t("./Button")
          , o = function(t) {
            ...
            n(e, [{
                key: "setState",
                value: function(t) {
                    this._currentState && this._currentState !== t && this._states[this._currentState].length && this.el.classList.remove(this._states[this._currentState]),
                    ...
                    this._states[t].length && this.el.classList.add(this._states[t])
                }
            }]),
            e
        }();
          ...
          , o = function(t) {
            ...
            n(e, [{
                ...
                value: function(t) {
                    ...
                    )(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "setState", this).call(this, t),
    ...
    251: [function(t, e, i) {
        ...
        o._bindContent = function(t) {
            if ("link" === t.type || "video" === t.type) {
                ...
                e.href = t.url || "",
                e.appendChild(i),
                "link" === t.type ? e.classList.add("icon", "icon-after", "icon-chevronright") : "video" === t.type && e.classList.add("icon", "icon-after", "icon-playcircle"),
        ...
        o._bindAction = function(t, e) {
            "function" == typeof e.onclick ? t.onclick = function(t) {
                t.preventDefault(),
                e.onclick.call(null, t)
            }
            .bind(this) : "video" === e.type && e.url && (t.onclick = function(t) {
                t.preventDefault(),
                this._player.load(e.url, null, 0, {})
            }
            .bind(this))
        }
        ,
    ...
    252: [function(t, e, i) {
        ...
        o.setData = function(t) {
            ...
            this.el.innerHTML = "",
            t ? (this.el.classList.remove("hidden"),
            this._addItems(t.items)) : this.el.classList.add("hidden")
        }
        ,
        o.destroy = function() {
            for (; this._items.length; )
        ...
        e.exports = function(t, e, i) {
            return e.classDef ? function(t, e, i) {
                ...
                return {
                    destroy: function() {
                        for (var e in r)
                            r.hasOwnProperty(e) && t.off(e, r[e]);
                        s && s()
                    }
                }
            }(t, e)
    ...
    257: [function(t, e, i) {
        ...
        d._onSpaceBarDown = function(t) {
            "BUTTON" !== t.target.tagName && "button" !== t.target.getAttribute("role") && (this._keyboard.offDown(o, this._onSpaceBarDown),
          ...
          , a = function(t) {
            function e(t) {
                ...
                var i = function(t, e) {
                  ...
                  , n = i._player.get360();
                return i._arrowControls = !n || n.arrowControls,
                i
            }
            return function(t, e) {
                if ("function" != typeof e && null !== e)
            ...
            n(e, [{
                ...
                value: function(t) {
                    if (t.target.classList.contains("controls-progress-indicator"))
                        return this._triggerKeyboardInteraction(),
                        void r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_onLeftArrowDown", this).call(this, t);
                    this._arrowControls.leftArrowDown(t)
                }
            }, {
                ...
                value: function(t) {
                    if (t.target.classList.contains("controls-progress-indicator"))
                        return this._triggerKeyboardInteraction(),
                        void r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_onRightArrowDown", this).call(this, t);
                    this._arrowControls.rightArrowDown(t)
                }
            }, {
                key: "_onUpArrowDown",
                value: function(t) {
                    if (t.target.classList.contains(s[0]) || t.target.classList.contains(s[1]))
                        return this._triggerKeyboardInteraction(),
                        void r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_onUpArrowDown", this).call(this, t);
                    t.originalEvent.preventDefault(),
                    this._arrowControls.upArrowDown(t)
                }
            }, {
                ...
                value: function(t) {
                    if (t.target.classList.contains(s[0]) || t.target.classList.contains(s[1]))
                        return this._triggerKeyboardInteraction(),
                        void r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_onDownArrowDown", this).call(this, t);
                    t.originalEvent.preventDefault(),
                    this._arrowControls.downArrowDown(t)
                }
            }, {
                key: "_onLeftArrowUp",
                value: function(t) {
                    t.target.classList.contains("controls-progress-indicator") ? this._triggerKeyboardInteraction() : (t.originalEvent.preventDefault(),
                    this._arrowControls.leftArrowUp(t))
                }
            }, {
                key: "_onRightArrowUp",
    ...
    259: [function(t, e, i) {
        ...
        var n, r;
        e.exports = function(e) {
            return e.threesixty ? (n || (n = t("./ThreeSixtyKeyboardControl")),
            new n(e)) : (r || (r = t("./KeyboardControl")),
            new r(e))
        }
    }
    , {
        ...
        var r = t("../localization/Localization")
          ...
          , a = function() {
            function t(e) {
                ...
                this._showTimeoutDelay = void 0 !== e.showTimeoutDelay ? e.showTimeoutDelay : s,
                this._bindMethods(),
                this._addEventListeners()
            }
            return n(t, [{
                ...
                key: "show",
                value: function(t) {
                    this._isPaused || (!0 !== t && this._started ? (clearTimeout(this._showTimeout),
    ...
    262: [function(t, e, i) {
        ...
        e.exports = {
            ...
            getTranslation: function(t) {
                var e = l((t = t || {}).lang);
                if (u(e))
                    return t.callback ? (t.callback(c[e]),
                    null) : c[e];
                if (!t.callback)
    ...
    265: [function(t, e, i) {
        ...
        l._onLoadedMetaData = function() {
            ...
            this._thumbnailHandler.setVertical(!1)) : t < e ? (this.el.classList.add("vertical-video"),
            this._thumbnailHandler.setVertical(!0)) : t === e ? (this.el.classList.add("square-video"),
        ...
        l.setPopUpPosition = function(t) {
            ...
            this._time = t,
            this._timeLabel.innerText = r.formatTime(t, this._getDuration()),
        ...
        l.setData = function(t) {
            ...
            t && this._player.getReadyState() > 2 ? (this.el.style.opacity = "1",
            this._thumbnailHandler.setData(t),
            this._cachedTrackerUpdate && (this._onTrackerUpdate(this._cachedTrackerUpdate),
            this._setThumbnail())) : (this._thumbnailHandler.setData(null),
            t ? (this._canPlayThroughHander = this.setData.bind(this, t),
        ...
        r.setData = function(t) {
            ...
            if (t.url !== this._imgUrl) {
                ...
                var e = this._loadImage(this._imgUrl).then(function() {
                    this._imageLoadPromise === e && (this.el.style.backgroundImage = 'url("' + this._imgUrl + '")',
    ...
    267: [function(t, e, i) {
        ...
        var d = t("@marcom/useragent-detect").os
          ...
          , f = function(t) {
            ...
            this._sharingButtonContainer = this.el.querySelector(".social-sharing-container"),
            ...
            p && (this.el.firstChild.classList.add("mobile"),
        ...
        m._initializeElement = function(t, e) {
            t ? this.el = t : (this.el = document.createElement("div"),
            this._templateData = l.getTranslation(),
            this.el.innerHTML = c((e || n).toString(), this._templateData))
        }
        ,
        m.setData = function(t) {
            if (t) {
                if (this._parentView.show(),
                t.allowEmbed && this.el.firstChild.classList.add("embed-enabled"),
                this._sharingUrl = t.originatorUrl || window.location.href,
                this._videoid = t.videoid,
                this._hideExtension = t.hideExtension,
                this._embedPath = t.embedpath || "https://www.apple.com/embed/",
                ...
                h && !1 !== t.analytics && t.videoid)
                    try {
                        ...
                        this._analyticsObserver || (this._analyticsObserver = h({
                            context: this.el
                        }))
                    } catch (t) {
                        o("ac-analytics-share failed to load, are you sure you've included it?")
        ...
        m._bindMethods = function() {
            ...
            this._doTwitterShare = this._doSocialShare.bind(this, a.TWITTER_TWEET),
        ...
        m._showTextArea = function(t) {
            t ? (this._container.classList.add("textarea-active"),
            s(this._copyTextArea),
            p || this._copyTextArea.setAttribute("readonly", "")) : (this._container.classList.remove("textarea-active"),
            this._copyLinkButton.classList.remove("active"),
            this._copyEmbedCodeButton.classList.remove("active"),
        ...
        m._focusFirstButton = function() {
            this._firstButton || (this._firstButton = u.getTabbableElements(this._sharingButtonContainer)[0]),
        ...
        m._initAnalyticsAttributes = function(t) {
            ...
            e.forEach(function(t) {
                ...
                t.button.setAttribute("data-analytics-share", JSON.stringify({
                    title: r,
                    events: t.events,
                    prop2: o + " - " + r + " - " + t.title,
                    prop18: i,
    ...
    275: [function(t, e, i) {
        ...
        s._onResize = function(t) {
            ...
            if (!1 !== t && this._player.refreshSize(),
        ...
        r.getBreakpointFromWidth = function(t, e, i, n) {
            for (var r = 0, o = n || e.length; r < o; r++) {
                var s = e[r];
                if (s !== i && (t >= s.minWidth && t <= s.maxWidth))
                    return s
            }
            return null
        }
        ...
        var n = t("@marcom/ac-string/supplant")
          , r = {
            ...
            formatTime: function(t, e, i) {
                ...
                .bind(this)),
                n(e >= 3600 ? "{PN}{hours}:{minutes}:{seconds}" : "{PN}{minutes}:{seconds}", {
            ...
            splitTime: function(t, e, i) {
                ...
                n.minutes = n.hours ? Math.floor(t / 60 % 60) : Math.floor(t / 60),
                n.seconds = t % 60,
                n)
            ...
            stringToNumber: function(t) {
                for (var e = 0, i = t.split(":"); i.length; )
                    3 === i.length ? e += 3600 * parseFloat(i.shift()) : 2 === i.length ? e += 60 * parseFloat(i.shift()) : e += parseFloat(i.shift());
                return e
            }
        };
        e.exports = r
    ...
    280: [function(t, e, i) {
        ...
        e.exports = function t() {
            ...
            var i = r(e.shift(), !0)
              , o = e.shift();
            for (var s in o)
                o.hasOwnProperty(s) && (i.hasOwnProperty(s) && "object" === n(i[s]) ? "object" === n(i[s]) && "object" === n(o[s]) && (i[s] = t(i[s], o[s])) : i[s] = o[s]);
    ...
    285: [function(t, e, i) {
        ...
        e.exports = {
            getVideoSource: function(t, e, i, a) {
                ...
                c.test(t);
                var v, y = {};
                if (y.width = parseInt(RegExp.$1, 10),
                ...
                var b, g = l[0].width, w = a && a.maxWidth ? Math.max(a.maxWidth, g) : u;
                if (!t)
                    throw "Must provide an url to optimize";
                if (void 0 === e || isNaN(e))
                    throw "Must provide a width";
                0 === e && (e = y.width),
                i && (l = l.filter(function(t) {
                    return t.type === i
                })),
                ...
                t.match(k) ? t.replace(k, n(E, b)) : t.match(r) ? t.replace(r, n(E, b)) : t
            },
          ...
          , h = function(t) {
            ...
            n(e, [{
                ...
                value: function(t) {
                    ...
                    this._enablePerformanceLogging = t.enablePerformanceLogging,
                ...
                value: function() {
                    if (this._hls) {
                        ...
                        this._hls.off(o.Events.DESIRED_RATE_CHANGED, this._onDesiredRateChanged),
                        this._hls.destroy();
                ...
                value: function(t, e) {
                    if (o) {
                        ...
                        this._hls.on(o.Events.DESIRED_RATE_CHANGED, this._onDesiredRateChanged),
                        this._src = t[0];
                        var i = function() {
                            this._mediaAttached = !0,
                            this._hls.off(o.Events.MEDIA_ATTACHED, i),
                            this.setSrc(t[0]),
                            this._createTextTrackTags(e)
                        }
                        .bind(this);
                        this._hls.on(o.Events.MEDIA_ATTACHED, i),
                        this._hls.attachMedia(this.el)
                    } else
                        this._deferredQueue.push(this.load.bind(this, t, e))
                }
            }, {
                key: "setSrc",
                value: function(t) {
                    o ? (this._hls || this._initHls(),
                    this._src = t,
                    this._manifestParsed = !1,
                    this._hls.loadSource(t, {
                        appData: {}
                    }),
                    this._hls.on(o.Events.MANIFEST_PARSED, this._boundManifestParsed = function() {
                        this._manifestParsed = !0,
                        this._hls.off(o.Events.MANIFEST_PARSED, this._boundManifestParsed),
                ...
                value: function() {
                    ...
                    r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_playPromiseRejected", this).call(this)
                }
            }, {
                key: "_onPlay",
                value: function() {
                ...
                key: "_onHlsError",
                value: function(t, e) {
                    !0 === e.fatal && ("fragLoadError" === e.details ? s("HLS JS threw a fatal fragLoadError error, but we'll try to let it recover because it probably can if the network/stream recovers") : (this._error = e.type,
                ...
                value: function() {
                    ...
                    r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "play", this).call(this))
                }
            }, {
                key: "pause",
                value: function() {
                    this._shouldPlay = !1,
                    r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "pause", this).call(this)
                }
            }, {
                key: "getPaused",
                value: function() {
        ...
        var r = t("../dom-emitter/DOMEmitterMicro")
          ...
          , l = function(t) {
            function e(t) {
                ...
                n._onTextTrackChangeAfterLoad = n._onTextTrackChangeAfterLoad.bind(n),
                n._textTracksEmitter = n.getTextTracksEventEmitter(),
                n._textTracksEmitter.on("addtrack", n._onTextTrackChangeAfterLoad),
            ...
            n(e, [{
                ...
                value: function(t) {
                    this.el.muted = t,
                    t ? this.el.setAttribute("muted", "") : this.el.removeAttribute("muted")
                }
            }, {
                key: "getEnded",
                value: function() {
                ...
                key: "setControls",
                value: function(t) {
                    t ? (this.el.setAttribute("controls", ""),
        ...
        var o = t("./HTML5Video")
          ...
          , a = function(t) {
            function e(t) {
                ...
                return i._renderElement = document.createElement("div"),
                i._renderElement.classList.add("threesixty-video-container"),
                i.el.style.visibility = "hidden",
                i.el.style.opacity = 0,
                i._renderElement.appendChild(i.el),
                i._ac360 = new s({
                    el: i._renderElement,
                ...
                .bind(i)),
                i.sendMouseDown = i.sendMouseDown.bind(i),
                i
            }
            return function(t, e) {
                if ("function" != typeof e && null !== e)
            ...
            n(e, [{
                ...
                value: function() {
                    ...
                    r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "load", this).apply(this, arguments)
                }
            }, {
                key: "play",
                value: function() {
    ...
    297: [function(t, e, i) {
        ...
        e.exports = function(t, e) {
            var i, r, o, s, a, c, l;
            return e ? (r = (i = t.getBoundingClientRect()).top,
            o = i.left,
            s = i.width,
            a = i.height,
            t.offsetParent && (r -= (c = t.offsetParent.getBoundingClientRect()).top,
            o -= c.left)) : (l = n(t, e),
            r = t.offsetTop,
            o = t.offsetLeft,
            s = l.width,
        ...
        e.exports = function(t, e, i) {
            ...
            return i = function(t, e, i) {
                ...
                Object.keys(n).forEach(function(n) {
                    var s = e[n];
                    ("string" == typeof s || s > 1) && (o = o || r(t, i),
                    s = (parseInt(s, 10) || 0) / ("x" === n ? o.width : o.height)),
                    e[n] = s
                }),
                e
            }(t, i, e),
    ...
    315: [function(t, e, i) {
        "use strict";
        var n, r = "data-films-modal-link", o = "data-films-inline-target", s = t("./factory/createFilms"), a = !0;
        e.exports = function t(e, i) {
            if (!(this instanceof t) && a)
                ...
                ;
            e = e || document;
            var c, l = Array.prototype.slice.call(e.querySelectorAll("[" + r + "]")), u = Array.prototype.slice.call(e.querySelectorAll("[" + o + "]"));
            if (l.length)
                c = s(l, Object.assign(i || {}, {
                    modal: !0
                }));
            else if (u.length) {
                ...
                for (var _ in h)
                    h.hasOwnProperty(_) && (c = s(h[_], Object.assign(i || {}, {
    ...
    316: [function(t, e, i) {
        ...
        l._bindAnchorForAnalytics = function(t) {
            var e;
            if (t) {
                if (this.sources[t.id])
                    return;
                e = this._createStubPlayer(t),
                t.getAttribute("data-" + this.options.dataAttribute) || (e.videoId = t.id),
                this.sources[t.id] = {
                    stubPlayer: e,
        ...
        l.setCurrentStubPlayer = function() {
            var t, e = this.player.el.getAttribute("data-" + this.options.dataAttribute), i = this._getCurrentSourceObject(e);
            i && i.stubPlayer && (this.currentStubPlayer = i.stubPlayer,
            this.playerType = "html5",
            (t = this.player.getCurrentSrc()) && (this.videoType = t.split(".").pop()))
        }
        ,
        l.destroy = function() {
            this.deactivate(),
        ...
        l._getCurrentSourceObject = function(t) {
            var e;
            return t && (e = this._getSourceObjectBySrcObjId(t)),
            e
        }
        ,
    ...
    320: [function(t, e, i) {
        ...
        t("@marcom/ac-console/log")("@marcom/ac-films version: " + t("../../../.versionfile").toString()),
        e.exports = function(t, e) {
            e = e || {},
            e = Object.assign({}, o, e);
            var i = n(t, e);
    ...
    323: [function(t, e, i) {
        ...
        e.exports = function(t, e) {
            ...
            i.appendChild(t.el);
            var r = n(i);
            return r.modalElement.classList.add("ac-modal-video"),
            new a({
                player: t,
                modal: r,
    ...
    324: [function(t, e, i) {
        ...
        a._onPipModeChanged = function() {
            ...
            this.modal.close()) : this._isModalOpen() || (this.modal.modalElement.classList.remove("ac-modal-video-pip"),
        ...
        a.play = function(t, e, i, r) {
            ...
            this.player.load(t, null, 0, Object.assign({}, e, {
                maxWidth: window.innerWidth
            })),
    ...
    326: [function(t, e, i) {
        ...
        c._onResize = function() {
            ...
            n > t && !this._isFullScreen ? this._playerContainer.parentElement.classList.add("center-horizontal") : this._playerContainer.parentElement.classList.remove("center-horizontal"),
            this._player.refreshSize()
        }
        ,
        e.exports = a
