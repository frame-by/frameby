!function() {
    ...
    4: [function(t, e, i) {
        ...
        e.exports = function(t, e) {
            ...
            var i = function() {
                var r = arguments
                  , s = e.apply(this, r);
                return s in i.cache || (i.cache[s] = t.apply(this, r)),
                i.cache[s]
            };
            return i.cache = {},
            i
    ...
    6: [function(t, e, i) {
        ...
        e.exports = function(t) {
            ...
            e = "filter" === t ? ["WebkitFilter", "filter"] : (t + " " + c.dom.join(i + " ") + i).split(" "),
            l = 0; l < e.length; l++)
                if ("undefined" != typeof n.style[e[l]])
                    return 0 !== l && c.reduce(l - 1),
                    a(t, e[l]);
            return a(t, !1)
        }
    }
    ...
    11: [function(t, e, i) {
        "use strict";
        var r, s, n = t("./stylePropertyCache"), o = t("./getStyleTestElement"), c = !1, a = function() {
            var t;
            if (!c) {
                c = !0,
    ...
    15: [function(t, e, i) {
        ...
        a._initializeBuyStrip = function() {
            var t, e;
            if (this._buystrip = document.querySelector(".ac-gf-buystrip"),
            this._buystrip)
                for (t = this._buystrip.querySelectorAll(".ac-gf-buystrip-info-content"),
                e = 0; e < t.length; e++)
                    this._makeBlockLink(t[e])
        }
        ,
        a._initializeChatLink = function() {
            var t;
            this._buystrip && (this._chatLink = this._buystrip.querySelector(".ac-gf-buystrip-info-cta-chat"),
            this._chatLink && (t = this._chatLink.parentNode,
        ...
        a._makeBlockLink = function(t) {
            ...
            if (e = t.querySelector("a")) {
                ...
                for (; t.childNodes.length > 1 && (s = t.childNodes[1],
                !s.href); )
                    r.appendChild(s)
            }
        }
