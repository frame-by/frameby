require = function() {
    ...
    1: [function(require, module, exports) {
        ...
        var e = require("@apple/analytics-utils")
          ...
          , a = [n.KEYS.PERSISTED, n.KEYS.DEFERRED_BEACON]
          , i = [{
            name: "btuid",
        ...
        var u = [].concat(p(n.KEYS.PATHS.CONFIG), ["global", "cookieDomain"])
          ...
          , f = e.pipe(function() {
            ...
            return e.cookieJson.set("mk_epub", null, l({}, o, {
                domain: b()
            })),
            n
        }, function(t) {
            var r = n.get(a);
            !e.beaconHelpers.isNotEmpty(t) || e.beaconHelpers.isNotEmpty(r) && t.btuid === r.btuid || n.set(a, t),
            n.remove([].concat(p(a), ["btuid"]))
        })
          , m = e.pipe(function(n) {
          ...
          , y = e.pipe(function() {
            ...
            e.beaconHelpers.isNotEmpty(n) && e.cookieJson.set("mk_epub", n, l({}, o, {
                domain: b()
            }))
        });
        exports.retrieve = f,
    ...
    , {
        ...
        "@apple/analytics-omniture-constants": 7,
        "@apple/analytics-utils": 10
    }],
    2: [function(require, module, exports) {
        ...
        var e = require("@apple/analytics-omniture-constants")
          , r = require("@apple/analytics-data-layer");
        function t(e, r, t) {
        ...
        var a = "pageLoad"
          , c = [r.KEYS.SESSION_STORE, r.KEYS.PAGE_LOAD, "prevPageName"];
        exports.previousPage = function() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
              , n = t.beacon
              , i = void 0 === n ? {} : n;
            return t.type !== a ? t : (i[e.VARS.PROP_14] = r.get(c),
            r.set(c, i[e.VARS.PAGE_NAME]),
            o({}, t, {
                beacon: i
            }))
        }
    ...
    3: [function(require, module, exports) {
        ...
        exports.PAGE_DATA_MODEL_LEGACY = "pageDataModelLegacy",
    ...
    4: [function(require, module, exports) {
        ...
        var e, t = require("@apple/analytics-data-layer-keys"), r = require("@apple/analytics-utils"), o = function() {
            r.localStorage.remove("mk_epub_expiry"),
            r.localStorage.remove("mk_epub")
        }, n = function() {
            return (Number(r.localStorage.get("mk_epub_expiry")) || 0) < Date.now()
        }, s = function() {
            clearTimeout(e),
            function t(o) {
                !o && n() || (r.localStorage.set("mk_epub_expiry", Date.now() + 72e5),
                e = setTimeout(t, 3e5))
            }(!0)
        };
        function i(e) {
        ...
        var u = function(e) {
          ...
          , g = function() {
            var e;
            l.persisted && ((e = p([l.persisted.key])) && "object" === i(e) && Object.keys(e).length ? (s(),
            r.localStorageJson.set("mk_epub", e)) : o())
        }
          , S = function() {
          ...
          , j = function(e, t) {
            ...
            y(o, t),
            l.persisted && o[0] === l.persisted.key && g(),
            l.sessionStore && o[0] === l.sessionStore.key && v()
        }
          , O = function() {
            var e;
            e = l.state && l.state.defaultState,
            f = u(e) ? e : {},
            function() {
                if (l.meta) {
                    for (var e = l.meta, t = e.key, r = e.selector, o = e.keyAttribute, n = e.keyPrefix, s = e.valueAttribute, i = {}, a = document.querySelectorAll(r), u = 0; u < a.length; u++)
                        i[a[u].getAttribute(o).replace(n, "")] = a[u].getAttribute(s);
                    j(t, i)
                }
            }(),
            function() {
        ...
        exports.init = function(e) {
            ...
            m(e),
            O(),
            l.persisted && "function" == typeof (t = k) && window.addEventListener("storage", function(e) {
                return function(t) {
                    "mk_epub" === t.key && e()
                }
            }(t)))
        ...
        exports.remove = function(e) {
            ...
            l.persisted && t[0] === l.persisted.key && g(),
            l.sessionStore && t[0] === l.sessionStore.key && v()
        }
        ,
        exports.set = j
    }
    ...
    5: [function(require, module, exports) {
        ...
        exports.mergeBeacons = function() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
              , n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            return Object.keys(n).forEach(function(o) {
                t[o]instanceof e.OmnitureCollection && n[o]instanceof e.OmnitureCollection ? t[o].merge(n[o]) : t[o] = n[o]
            }),
            t
        }
    }
    , {
        "@apple/analytics-omniture-collection": 6
    }],
    6: [function(require, module, exports) {
        ...
        var g = function(t) {
          ...
          , S = function() {
            ...
            return e.reduce(function(t, e) {
                return e instanceof j ? t.push.apply(t, b(e.values())) : t.push(e),
                t
            }, []).filter(function(t) {
          ...
          , j = function(t) {
            function e() {
                var t, n;
                return r(this, e),
                (t = n = h(this, s(e).call(this))).merge.apply(t, arguments),
                n
            }
            return c(e, y(Map)),
            i(e, [{
          ...
          , E = function(e) {
            function n(t, e) {
                var i;
                return r(this, n),
                (i = h(this, s(n).call(this, t))).value = e,
                i
            }
            return c(n, m),
            i(n, [{
          ...
          , P = function(e) {
            function n() {
                ...
                return o.sku = t.beaconHelpers.guessPartNumber(o.sku),
                (e = h(this, s(n).call(this, o.sku))).sku = o.sku,
                e.category = o.category,
                e.qty = o.qty,
                e.price = o.price,
                e.events = o.events,
                e.variables = o.variables,
                e
            }
            return c(n, m),
            i(n, [{
                key: "merge",
                value: function(t) {
                    return t instanceof n && t.key === this.key && (this.category = t.category || this.category,
        ...
        exports.OmnitureCollection = j,
        exports.OmnitureEvent = E,
        exports.OmnitureItem = m,
        exports.OmnitureProduct = P,
        exports.OmnitureVariable = x,
        exports.parseEventCollectionString = T,
        ...
        exports.parseProductCollectionString = function(t) {
            ...
            return t && "string" == typeof t ? (function(t) {
                return t && "string" == typeof t ? t.split(d).filter(Boolean).reduce(function(t, e) {
                    return t.length && !e.includes(k) ? t[t.length - 1] += d + e : t.push(e),
                    t
                }, []) : []
            }(t).forEach(function(t) {
                !function(t, e) {
                    if (!(t instanceof j && e instanceof P))
                        return t;
                    var r = t.get(e.sku);
                    if (!r)
                        return t.add(e);
                    ...
                    r.events.merge(e.events, new E(q,n), new E(A,i))
                }(e, function(t) {
                    if (!t || "string" != typeof t)
                        return null;
                    var e, r, n = v(t.split(k), 6), i = n[0], o = n[1], u = n[2], a = n[3], c = n[4], s = n[5], f = {
                        category: i,
                        sku: o,
                        qty: u,
                        price: a,
                        ...
                        variables: (e = s,
                        r = new j,
                        e && "string" == typeof e ? (e.split(O).forEach(function(t) {
                            var e = v(t.split("="), 2)
                              , n = e[0]
                              , i = e[1];
                            n && i && r.add(new x(n,i))
    ...
    7: [function(require, module, exports) {
        ...
        var t = function() {
            for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, r = e.keyPrefix, t = void 0 === r ? "" : r, n = e.valuePrefix, c = void 0 === n ? "" : n, o = e.count, E = void 0 === o ? 0 : o, i = {}, a = 1; a <= E; a++)
                i["".concat(t).concat(a)] = "".concat(c).concat(a);
            return i
        }
          , n = function(t) {
            for (var n = 1; n < arguments.length; n++) {
        ...
        c.SC_ADD = "scAdd",
        c.PROD_VIEW = "prodView",
        exports.EVAR_MAX = 155,
        exports.EVENTS = c,
        exports.EVENT_MAX = 420,
        exports.PROP_MAX = 75,
    ...
    8: [function(require, module, exports) {
        ...
        var t = function(t) {
          ...
          , r = function(r, o, c) {
            return !t(r) || "string" != typeof o[r] || (i = o[r],
            !n(i) && !e(i)) || c >= 5;
            var i
        }
          , o = function(t) {
        ...
        exports.getBeacon = function(n) {
            ...
            return Array.isArray(e) && e.forEach(function(n) {
                t(n) && (c[n] ? (u.events = s(u.events, n),
                u.eVar17 = l(u.eVar17, c[n])) : o && o[n] && (u.events = s(u.events, n),
                u.eVar17 = l(u.eVar17, o[n])))
            }),
            u
        }
        ,
        ...
        exports.relayRead = function() {
            ...
            return Object.keys(o).forEach(function(n) {
                u[n] && t(n) && (a.set(o[n], u[n]),
                v.events = s(v.events, n),
                v.eVar17 = l(v.eVar17, u[n]))
            }),
            {
    ...
    9: [function(require, module, exports) {
        ...
        exports.begin = function() {
            var r, E = (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}).action, i = void 0 === E ? "" : E;
            return o(r = {}, t.VARS.PROP_3, "".concat(n.toStrTrim(i) || "engage", " - search field")),
            o(r, t.VARS.EVENTS, new e.OmnitureCollection(new e.OmnitureEvent(c.BEGIN))),
            r
        }
        ,
        exports.exit = function() {
            var r, E = (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}).keyword;
            return o(r = {}, t.VARS.PROP_7, n.toStrTrim(E).toLowerCase()),
            o(r, t.VARS.PROP_29, null),
            o(r, t.VARS.EVAR_2, "D=c7"),
            o(r, t.VARS.EVENTS, new e.OmnitureCollection(new e.OmnitureEvent(c.EXIT))),
            r
        }
        ,
        exports.pagination = function() {
            var r, E = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, i = E.currentPage, a = E.nextPage, s = E.action, S = void 0 === s ? "click" : s;
            return o(r = {}, t.VARS.PROP_2, "".concat(n.toStrTrim(S), " - page ").concat(n.toStrTrim(i))),
            o(r, t.VARS.PROP_3, "".concat(n.toStrTrim(S), " - page ").concat(n.toStrTrim(a))),
            o(r, t.VARS.EVAR_15, "search (search)"),
            o(r, t.VARS.EVENTS, new e.OmnitureCollection(new e.OmnitureEvent(c.SEARCH),new e.OmnitureEvent(c.PAGINATION))),
            r
        }
        ,
        exports.perform = function() {
            var r, E = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, a = E.keyword, u = E.method, V = E.position, T = E.results, l = E.source, p = E.suggestedValue, _ = E.type, N = n.toStrTrim(a).toLowerCase(), R = "no keyword" === N ? "" : N, O = n.toStrTrim(p).toLowerCase(), m = s(_), d = "suggestions" === _ ? "suggested" : u;
            return i({}, void 0 !== V ? o({}, t.VARS.EVAR_23, [R, O, d, T, V].map(n.toStrTrim).join("|")) : {}, (o(r = {}, t.VARS.PROP_7, S.includes(_) ? O : N || "___blank___"),
            o(r, t.VARS.EVAR_2, "D=c7"),
            o(r, t.VARS.EVAR_15, "".concat(n.toStrTrim(l), " (").concat("suggestions" === _ ? "typed" : n.toStrTrim(u), ")")),
            o(r, t.VARS.EVENTS, m.add(new e.OmnitureEvent(c.SEARCH))),
            r))
        }
        ,
        exports.resultClick = function() {
            var E, i, a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, s = a.accessoriesLink, S = a.storeLink, V = a.serviceLink, T = a.bannerLink, l = a.keyword, p = a.intent, _ = a.position, N = a.results, R = a.relayId, O = a.URLObject, m = n.toStrTrim(l).toLowerCase(), d = new e.OmnitureCollection(new e.OmnitureEvent(c.COMPLETE));
            if (s && d.add(new e.OmnitureEvent(c.ACCESSORIES_LINK)),
            S && d.add(new e.OmnitureEvent(c.STORE_LINK)),
            O) {
                var A = u(O);
                A && (d.add(new e.OmnitureEvent(A.event)),
                i = r.getOne(A.token) || "aos_search_result")
            }
            return o(E = {}, t.VARS.PROP_7, m),
            o(E, t.VARS.PROP_29, T ? "" : [m, p, N, _].map(n.toStrTrim).join("|")),
            o(E, t.VARS.EVAR_2, "D=c7"),
            o(E, t.VARS.EVAR_17, i || (V ? R || "aos_search_result" : "")),
            o(E, t.VARS.EVENTS, d),
            E
        }
        ,
        exports.serpPageLoad = function() {
            var r, E, a, s = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, S = s.directLanding, u = s.keyword, V = s.intent, T = s.results, l = s.channelPrefix, p = s.curatedKit, _ = new e.OmnitureCollection(new e.OmnitureEvent(c.SEARCH));
            T || _.add(new e.OmnitureEvent(c.NO_RESULTS)),
            p && _.add(new e.OmnitureEvent(c.CURATED));
            var N = "".concat(n.toStrTrim(l), ":search");
            return i({}, (o(r = {}, t.VARS.CHANNEL, N),
            o(r, t.VARS.HIER1, N),
            o(r, t.VARS.PAGE_NAME, "".concat(N, ":").concat(n.toStrTrim(V))),
            o(r, t.VARS.PROP_21, n.toStrTrim(T) || "0"),
            r), S ? (o(E = {}, t.VARS.PROP_7, n.toStrTrim(u).toLowerCase()),
            o(E, t.VARS.EVAR_2, "D=c7"),
            o(E, t.VARS.EVAR_15, "external (direct)|".concat(n.toStrTrim(V))),
            o(E, t.VARS.EVENTS, _.add(new e.OmnitureEvent(c.SERP_DIRECT))),
            E) : (o(a = {}, t.VARS.EVAR_15, "|".concat(n.toStrTrim(V))),
            o(a, t.VARS.EVENTS, _),
            a))
        }
    }
    ...
    10: [function(require, module, exports) {
        ...
        var e = function() {
          ...
          , n = function(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}
              , o = r(null == t ? -1 : n.expires)
              , i = o ? "; expires=" + o.toUTCString() : ""
              , u = n.path ? "; path=" + n.path : ""
              , c = n.domain ? "; domain=" + n.domain : ""
              , a = n.secure ? "; secure" : "";
            document.cookie = e + "=" + encodeURIComponent(t || "") + i + u + c + a
        }
          , o = Object.freeze({
            __proto__: null,
            get: t,
        ...
        var f = function() {
          ...
          , _ = function(e) {
            ...
            if ("string" != typeof e)
                return null;
            var t = l(e.replace(/[^\d.,]/g, "").split(/[.,](\d{1,2})$/), 2)
              , r = t[0]
              , n = void 0 === r ? "0" : r
              , o = t[1]
              , i = void 0 === o ? "00" : o
          ...
          , O = [/^APPLE/, /^HOMEPOD/, /^IMAC/, /^IPAD/, /^IPHONE/, /^IPOD/, /^MAC/, /^PRO/, /^W\d\d_/, /^Z/, /\+/, /GIFT_CARDS/]
          , w = function(e) {
            return !(!e || "object" !== i(e) || Array.isArray(e))
        }
          , j = w
          ...
          , x = function(e) {
            return e && "object" !== i(e) ? String(e) : null
        }
          , A = Object.freeze({
            __proto__: null,
          ...
          , U = function(e, t) {
            return t && t.length ? t.reduce(function(e, t) {
                return e && "object" === i(e) ? e[t] : null
            }, e) : e
        }
          , F = function(e, t, r) {
            return t && t.length ? H(e, s(t).reverse(), r) : e
        }
          , H = function e(t, r, n) {
            if (!r.length)
                return n;
            if ("object" === i(t)) {
                var o = r.pop()
                  , u = Array.isArray(t) ? s(t) : a({}, t);
                return u[o] = e(u[o], r, n),
                u
            }
            return e({}, r, n)
        }
          , J = function e(t, r) {
            var n = r.pop()
              , o = Array.isArray(t) ? s(t) : a({}, t);
            return r.length ? ("object" === i(o[n]) && (o[n] = e(o[n], r)),
          ...
          , V = Object.freeze({
            ...
            formatPath: function e() {
                ...
                return r.map(function(t) {
                    return Array.isArray(t) ? e.apply(void 0, s(t)) : D(t).split(M)
                }).reduce(function(e, t) {
                    return e.concat(t)
                }, [])
            },
            ...
            remove: function(e, t) {
                return t && t.length && "object" === i(e) ? J(e, s(t).reverse()) : e
            }
        })
          , K = Object.freeze({
            __proto__: null,
            ...
            isValidObject: function(e, t) {
                return w(e) && Array.isArray(t) && t.every(function(t) {
                    return e[t]
                })
            }
        })
          ...
          , re = ["applenews:", "itms-apps:"]
          , ne = ["apps.apple.com", "news.apple.com", "music.apple.com", "wallet.apple.com", "tv.apple.com", "books.apple.com"]
          , oe = Object.freeze({
            __proto__: null,
            getOrigin: X,
            isAccessoriesSERPLink: function(e) {
                return ee(e, "as-producttile-tilelink", "pd-onebox-block")
            },
            isCrossOriginLink: function(e) {
                return Y(e) && X(e) !== X(window.document.location)
            },
            isExitLink: function(e) {
                return Y(e) && void 0 !== e.dataset.analyticsExitLink
            },
            isExternalLink: function(e) {
                return !(!Y(e) || !e.hostname) && ((E() || {}).linkInternalFilters || "").split(",").every(function(t) {
                    return e.hostname.indexOf(t.trim()) < 0
                })
            },
            isGlobalNavLink: function(e) {
                return ee(e, "ac-gn-link")
            },
            isImmediateLink: function(e) {
                return ee(e, "as-analytics-sendimmediately")
            },
            isMarcomUrl: function(e) {
                return !!e && e.indexOf("shop") < 0 && e.indexOf("search") < 0
            },
            isSearchLink: function(e) {
                return ee(e, "ac-gn-searchresults-link")
            },
            ...
            isSignInLink: function(e) {
                return ee(e, "ac-gn-bagview-nav-link-signIn")
            },
            isSignOutLink: function(e) {
                return ee(e, "ac-gn-bagview-nav-link-signOut")
            },
            ...
            redirectsToSignInLink: function(e) {
                return ee(e, "ac-gn-bagview-nav-item-favorites", "ac-gn-bagview-nav-item-orders", "ac-gn-bagview-nav-item-account", "ac-gn-bagview-nav-item-signIn")
            },
        ...
        exports.asCookie = m,
        exports.asCookieJson = h,
        exports.beaconHelpers = A,
        exports.cookie = o,
        exports.cookieJson = P,
        exports.deepClone = function e(t) {
            ...
            for (var o = {}, u = 0, c = Object.keys(t); u < c.length; u++) {
                var a = c[u];
                o[a] = e(t[a])
            }
            return o
        ...
        ,
        exports.eventHelpers = I,
        exports.getOmniture = E,
        exports.getRandomInt = function() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1e3;
            return Math.floor(Math.random() * Math.floor(e))
        }
        ,
        exports.jsonEncoder = d,
        exports.localStorage = C,
        exports.localStorageJson = R,
        exports.objectHelpers = K,
        exports.objectPath = V,
        exports.pipe = e,
        exports.sessionStorage = Z,
        exports.sessionStorageJson = q,
        exports.toStr = D,
        exports.toStrTrim = Q,
        exports.urlHelpers = oe
    }
    , {}],
    ...
    37: [function(require, module, exports) {
        ...
        module.exports = {
            parentNode: function(E, N, e, _) {
                if (_ = _ || "target",
                (E || N) && !isNodeType(E, VALID_PARENT_NODE))
                    throw new TypeError(e + ": " + _ + ERR_INVALID_PARENT_NODE)
            },
            childNode: function(E, N, e, _) {
                if (_ = _ || "target",
                (E || N) && !isNodeType(E, VALID_CHILD_NODE))
                    throw new TypeError(e + ": " + _ + ERR_INVALID_CHILD_NODE)
            },
            insertNode: function(E, N, e, _) {
                if (_ = _ || "node",
                (E || N) && !isNodeType(E, VALID_INSERT_NODE))
                    throw new TypeError(e + ": " + _ + ERR_INVALID_INSERT_NODE)
            },
            hasParentNode: function(E, N, e) {
                if (e = e || "target",
                !E.parentNode)
    ...
    41: [function(require, module, exports) {
        ...
        var validate = require("./internal/validate");
        module.exports = function(e) {
            return validate.childNode(e, !0, "remove"),
            e.parentNode ? e.parentNode.removeChild(e) : e
        }
    }
    , {
        "./internal/validate": 37
    }],
    42: [function(require, module, exports) {
        ...
        module.exports = function(e, t, r, a) {
            if (validate.childNode(e, !0, "ancestors"),
            validate.selector(t, !1, "ancestors"),
            r && isElement(e) && (!t || matchesSelector(e, t)))
                return e;
            if (e !== (a = a || document.body))
                for (; (e = e.parentNode) && isElement(e); ) {
                    if (!t || matchesSelector(e, t))
                        return e;
                    if (e === a)
                        break
                }
    ...
    , {
        ...
        "./matchesSelector": 46,
        "@marcom/ac-dom-nodes/isElement": 39
    }],
    ...
    44: [function(require, module, exports) {
        ...
        module.exports = {
            parentNode: function(e, E, N, o) {
                if (o = o || "node",
                (e || E) && !isNodeType(e, VALID_PARENT_NODE))
                    throw new TypeError(N + ": " + o + ERR_INVALID_PARENT_NODE)
            },
            childNode: function(e, E, N, o) {
                if (o = o || "node",
                (e || E) && !isNodeType(e, VALID_CHILD_NODE))
                    throw new TypeError(N + ": " + o + ERR_INVALID_CHILD_NODE)
            },
            selector: function(e, E, N, o) {
                if (o = o || "selector",
                (e || E) && "string" != typeof e)
                    throw new TypeError(N + ": " + o + ERR_INVALID_SELECTOR)
            }
        }
    }
    , {
        "@marcom/ac-dom-nodes/COMMENT_NODE": 31,
        "@marcom/ac-dom-nodes/DOCUMENT_FRAGMENT_NODE": 32,
        "@marcom/ac-dom-nodes/DOCUMENT_NODE": 33,
        "@marcom/ac-dom-nodes/ELEMENT_NODE": 34,
        "@marcom/ac-dom-nodes/TEXT_NODE": 35,
        "@marcom/ac-dom-nodes/isNode": 40,
        "@marcom/ac-polyfills/Array/prototype.indexOf": 67
    }],
    ...
    46: [function(require, module, exports) {
        ...
        module.exports = function(e, t) {
            return validate.selector(t, !0, "matchesSelector"),
            !!isElement(e) && (nativeMatches ? nativeMatches.call(e, t) : matchesSelectorShim(e, t))
        }
    }
    , {
        "./internal/nativeMatches": 43,
        "./internal/validate": 44,
        "./shims/matchesSelector": 48,
        "@marcom/ac-dom-nodes/isElement": 39
    }],
    47: [function(require, module, exports) {
        ...
        module.exports = function(e, l) {
            return l = l || document,
            validate.parentNode(l, !0, "querySelectorAll", "context"),
            validate.selector(e, !0, "querySelectorAll"),
            querySelectorAllAvailable ? Array.prototype.slice.call(l.querySelectorAll(e)) : querySelectorAllShim(e, l)
        }
    }
    , {
        "./internal/validate": 44,
        "./shims/querySelectorAll": 49,
        "@marcom/ac-polyfills/Array/prototype.slice": 68
    }],
    48: [function(require, module, exports) {
        "use strict";
        var querySelectorAll = require("../querySelectorAll");
        module.exports = function(e, r) {
            var t, l = e.parentNode || document, u = querySelectorAll(r, l);
    ...
    49: [function(require, module, exports) {
        ...
        var isElement = require("@marcom/ac-dom-nodes/isElement")
          ...
          , isElementInContext = function(e, t) {
            ...
            if (t === document)
                return !0;
            for (n = e; (n = n.parentNode) && isElement(n); )
                if (n === t)
                    return !0;
            return !1
        }
        ...
        module.exports = function(e, t) {
            var n, r = document.createElement("style"), c = COLLECTION_PREFIX + (Math.random() + "").slice(-6), o = [];
            for (t = t || document,
            document[c] = [],
            isDocumentFragment(t) ? t.appendChild(r) : document.documentElement.firstChild.appendChild(r),
            r.styleSheet.cssText = "*{display:recalc;}" + e + '{ac-qsa:expression(document["' + c + '"] && document["' + c + '"].push(this));}',
            recalcStyles(t); document[c].length; )
                (n = document[c].shift()).style.removeAttribute("ac-qsa"),
                -1 === o.indexOf(n) && isElementInContext(n, t) && o.push(n);
    ...
    , {
        "@marcom/ac-dom-nodes/isDocumentFragment": 38,
        "@marcom/ac-dom-nodes/isElement": 39,
        "@marcom/ac-dom-nodes/remove": 41,
        "@marcom/ac-polyfills/Array/prototype.indexOf": 67
    }],
    ...
    , {
        "./ac-element-engagement/ElementEngagement": 51
    }],
    ...
    , {
        "@marcom/ac-element-tracker": 57,
        "@marcom/ac-event-emitter-micro": 60,
        "@marcom/ac-object/defaults": 63,
        "@marcom/ac-object/extend": 64
    }],
    ...
    , {
        "./ac-element-tracker/ElementTracker": 58,
        "./ac-element-tracker/TrackedElement": 59
    }],
    ...
    , {
        "./TrackedElement": 59,
        "@marcom/ac-dom-metrics/getDimensions": 15,
        "@marcom/ac-dom-metrics/getPagePosition": 16,
        "@marcom/ac-dom-metrics/getScrollY": 18,
        "@marcom/ac-dom-nodes/isElement": 54,
        "@marcom/ac-dom-nodes/isNodeList": 56,
        "@marcom/ac-object/clone": 62,
        "@marcom/ac-object/extend": 64
    }],
    ...
    , {
        "./ac-event-emitter-micro/EventEmitterMicro": 61
    }],
    ...
    , {
        "./extend": 64,
        "@marcom/ac-polyfills/Array/isArray": 65
    }],
    ...
    , {
        "@marcom/ac-polyfills/Array/prototype.forEach": 66
    }],
    ...
    , {
        "./appmeasurement-setup/AppMeasurementSetup": 73
    }],
    70: [function(require, module, exports) {
        !function() {
            ...
            window.AppMeasurement_Module_ActivityMap = function(e) {
                ...
                function i(t, n, a, i, r) {
                    ...
                    !o && e.useForcedLinkTracking && r) {
                        ...
                        i && t && 0 <= (n = t.indexOf(i))) {
                            ...
                            for (c = !1; n < t.length && s && (a = t.charAt(n),
                            c || a !== s); )
                                "\\" === a ? c = !0 : (varValue += a,
                                c = !1),
                                n++
                ...
                function r(e, t, n) {
                    var i;
                    return (i = c[t](e, n)) && (p ? (p = 0,
                    i) : a(o(i), c[t + "Exclusions"]))
                }
                function o(e) {
                    if (null == e || null == e)
                        return e;
                ...
                c.link = function(e, t) {
                    ...
                    if (t)
                        ...
                        (s = a(o(e.innerText || e.textContent), c.linkExclusions)) || (function e(t, n, a) {
                            var i;
                            if (t && !(1 === (i = t.nodeType) && (i = t.nodeName) && (i = i.toUpperCase()) && g[i]) && (1 === t.nodeType && (i = t.nodeValue) && (n[n.length] = i),
            ...
            window.AppMeasurement = function(e) {
                ...
                t.Kb = function() {
                    ...
                    a && !t.Ia && !/^[0-9.]+$/.test(a) && (i = 2 < (i = i ? parseInt(i) : 2) ? i : 2,
                    0 <= (e = a.lastIndexOf(".")))) {
                        for (; 0 <= e && 1 < i; )
                            e = a.lastIndexOf(".", e - 1),
                            i--;
                        t.Ia = 0 < e ? a.substring(e) : a
                    }
                    return t.Ia
                }
                ,
                ...
                t.c_w = t.cookieWrite = function(e, n, a) {
                    var i, r = t.Kb(), o = t.cookieLifetime;
                    return n = "" + n,
                    o = o ? ("" + o).toUpperCase() : "",
                    ...
                    e && "NONE" != o ? (t.d.cookie = t.escape(e) + "=" + t.escape("" != n ? n : "[[B]]") + "; path=/;" + (a && "SESSION" != o ? " expires=" + a.toUTCString() + ";" : "") + (r ? " domain=" + r + ";" : ""),
                    t.cookieRead(e) == n) : 0
                }
                ,
                t.Hb = function() {
                ...
                t.delayReady = function() {
                    ...
                    for (t.u("_d") ? a = 1 : t.ya(); 0 < t.K.length; ) {
                        if (e = t.K.shift(),
                        a && !e.t && e.t > n) {
                            t.K.unshift(e),
                ...
                t.foreachVar = function(e, n) {
                    ...
                    (c = t.lightTrackVars) && (c = "," + c + "," + t.ka.join(",") + ",")) : (a = t.g,
                                    ...
                                    c) {
                                        if ("retrieveLightData" == i && 0 > r.indexOf(".contextData."))
                                            ...
                                            case "campaign":
                                                ...
                                                break;
                                            default:
                                                t.Pa(l) && ("prop" == s ? o = "c" + l : "eVar" == s ? o = "v" + l : "list" == s ? o = "l" + l : "hier" == s && (o = "h" + l,
                                                c = c.substring(0, 255)))
                                            }
                ...
                t.Nb = function() {
                    ...
                    (f = t.lightTrackVars) && (f = "," + f + "," + t.ka.join(",") + ",")) : (e = t.g,
                    ...
                    for (t.AudienceManagement && t.AudienceManagement.isReady() && (u += t.o("d", t.AudienceManagement.getEventCallConfigParams())),
                    n = 0; n < e.length; n++) {
                        if (r = e[n],
                        o = t[r],
                        i = r.substring(0, 4),
                        ...
                        o && (!f || 0 <= f.indexOf("," + r + ","))) {
                            ...
                            case "retrieveLightData":
                                ...
                                break;
                            default:
                                t.Pa(c) && ("prop" == i ? r = "c" + c : "eVar" == i ? r = "v" + c : "list" == i ? r = "l" + c : "hier" == i && (r = "h" + c,
                                o = o.substring(0, 255)))
                            }
                ...
                t.B = function(e) {
                    var t = e.tagName;
                    return "undefined" != "" + e.hc || "undefined" != "" + e.Wb && "HTML" != ("" + e.Wb).toUpperCase() ? "" : ("SHAPE" == (t = t && t.toUpperCase ? t.toUpperCase() : "") && (t = ""),
                ...
                t.L = function(e) {
                    ...
                    o = 3) : "IMAGE" == i && e.src && (r = e.src) : r = t.La(e),
                    r) ? {
                ...
                t.Vb = function() {
                    ...
                    !c && s) {
                        ...
                        if (t.trackDownloadLinks && t.linkDownloadFileTypes)
                            ...
                            r = 0; r < i.length; r++)
                                (u = i[r]) && l.substring(l.length - (u.length + 1)) == "." + u && (c = "d");
                        if (t.trackExternalLinks && !c && (l = s.toLowerCase(),
                        t.Oa(l) && (t.linkInternalFilters || (t.linkInternalFilters = n.location.hostname),
                        i = 0,
                ...
                t.Ob = function() {
                    ...
                    e = 1),
                    t.abort && (e = 0),
                    t.trackClickMap || t.trackInlineStats || t.Rb()) {
                        n = {},
                        a = 0;
                        var r, o, c, s = (l = t.pb()) ? l.split("&") : 0, l = 0;
                        if (s)
                ...
                ,
                t.pb = function() {
                    return t.useLinkTrackSessionStorage ? t.Ca() ? n.sessionStorage.getItem(t.P) : void 0 : t.cookieRead(t.P)
                }
                ,
                t.Ca = function() {
                ...
                ,
                t.wb = function(e) {
                    t.useLinkTrackSessionStorage ? t.Ca() && n.sessionStorage.setItem(t.P, e) : t.cookieWrite(t.P, e)
                }
                ,
                t.Pb = function() {
                    if (!t.Zb) {
                ...
                t.loadModule = function(e, a) {
                    ...
                    if (!i) {
                        ...
                        ,
                        i.xb = function(n) {
                            (i.sb = n) && (t[e + "_onLoad"] = n,
                            t.ea(e + "_onLoad", [t, i], 1) || n(t, i))
                        }
                        ;
                        try {
                ...
                t.isReadyToTrack = function() {
                    var e = !0;
                    return !(!t.mb() || !t.kb()) && (t.ob() || (e = !1),
                    t.rb() || (e = !1),
                    e)
                }
                ,
                t.mb = function() {
                    return t.ba || t.H || (t.bb(t.zb) ? t.H = !0 : t.ba = !0),
                    !(t.ba && !t.H)
                }
                ,
                t.kb = function() {
                    ...
                    if (e) {
                        if (!t.ra && !t.aa)
                            return e.fetchPermissions(t.tb, !0),
                            t.aa = !0,
                            !1;
                        if (!t.ra)
                            return !1;
                ...
                ,
                t.rb = function() {
                    return t.Z || t.G || (t.ab(t.ya) ? t.G = !0 : t.Z = !0),
                    !(t.Z && !t.G)
                }
                ,
                t.aa = !1,
                ...
                t.p = function() {
                    var e;
                    if (t.isReadyToTrack() && (t.yb(),
                    t.j != a))
                        for (; 0 < t.j.length; )
                            (e = t.j.shift()).Db.apply(e.Eb, e.Bb)
                }
                ,
                t.yb = function() {
                ...
                t.ta = function(e) {
                    ...
                    e != a)
                        for (n in e)
                            i[n] = e[n];
                    t.callbackWhenReadyToTrack(t, t.Da, [i]),
                    t.Ba()
                }
                ,
                t.Lb = function() {
                ...
                t.Da = function(e) {
                    ...
                    t.T());
                    e && (a = t.S(e, 1)),
                    t.Sb() && !t.visitorOptedOut && (t.wa() || (t.fid = t.Lb()),
                    t.Vb(),
                    ...
                    t.referrer || t.Za || (e = t.Util.getQueryParam("adobe_mc_ref", null, null, !0),
                    t.referrer = e || void 0 === e ? void 0 === e ? "" : e : c.document.referrer),
                    t.Za = 1,
                    t.referrer = t.Jb(t.referrer),
                    t.u("_g")),
                    t.Ob() && !t.abort && (s && t.V("TARGET") && !t.supplementalDataID && s.getSupplementalDataID && (t.supplementalDataID = s.getSupplementalDataID("AppMeasurement:" + t._in, !t.expectSupplementalData)),
                ...
                t.t = t.track = function(e, n) {
                    n && t.S(n),
                    t.Y = !0,
                    t.isReadyToTrack() ? null != t.j && 0 < t.j.length ? (t.ta(e),
                    t.p()) : t.Da(e) : t.ta(e)
                }
                ,
                t.Ba = function() {
                ...
                t.registerPreTrackCallback = function(e) {
                    for (var n = [], a = 1; a < arguments.length; a++)
                        n.push(arguments[a]);
                    "function" == typeof e ? t.Aa.push([e, n]) : t.debugTracking && t.C("DEBUG: Non function type passed to registerPreTrackCallback")
                }
                ,
                t.fb = function(e) {
                    t.ua(t.Aa, e)
                ...
                t.registerPostTrackCallback = function(e) {
                    for (var n = [], a = 1; a < arguments.length; a++)
                        n.push(arguments[a]);
                    "function" == typeof e ? t.za.push([e, n]) : t.debugTracking && t.C("DEBUG: Non function type passed to registerPostTrackCallback")
                }
                ,
                t.eb = function(e) {
                    t.ua(t.za, e)
                ...
                t.qb = function(e, n) {
                    var a = t.gb() + "/" + e + "?AQB=1&ndh=1&pf=1&" + (t.xa() ? "callback=s_c_il[" + t._in + "].doPostbacks&et=1&" : "") + n + "&AQE=1";
                    t.fb(a),
                    t.cb(a),
                    t.U()
                }
                ...
                t.gb = function() {
                    var e = t.hb();
                    return "http" + (t.ssl ? "s" : "") + "://" + e + "/b/ss/" + t.account + "/" + (t.mobile ? "5." : "") + (t.xa() ? "10" : "1") + "/JS-" + t.version + (t.Yb ? "T" : "") + (t.tagContainerMarker ? "-" + t.tagContainerMarker : "")
                }
                ,
                t.xa = function() {
                ...
                ,
                t.Ya = /{(%?)(.*?)(%?)}/,
                t.bc = RegExp(t.Ya.source, "g"),
                t.Ib = function(e) {
                    if ("object" == typeof e.dests)
                        for (var n = 0; n < e.dests.length; ++n) {
                            var a = e.dests[n];
                            if ("string" == typeof a.c && "aa." == a.id.substr(0, 3))
                                for (var i = a.c.match(t.bc), r = 0; r < i.length; ++r) {
                                    var o = i[r]
                                      , c = o.match(t.Ya)
                                      , s = "";
                                    "%" == c[1] && "timezone_offset" == c[2] ? s = (new Date).getTimezoneOffset() : "%" == c[1] && "timestampz" == c[2] && (s = t.Mb()),
                ...
                t.doPostbacks = function(e) {
                    if ("object" == typeof e)
                        ...
                        "object" == typeof t.AudienceManagement && "function" == typeof t.AudienceManagement.isReady && t.AudienceManagement.isReady() && "function" == typeof t.AudienceManagement.passData)
                            ...
                            for (var n = 0; n < e.dests.length; ++n) {
                                var a = e.dests[n];
                                "object" == typeof a && "string" == typeof a.c && "string" == typeof a.id && "aa." == a.id.substr(0, 3) && (t.pa[a.id] = new Image,
                                t.pa[a.id].alt = "",
                                t.pa[a.id].src = a.c)
                            }
                }
                ...
                t.Tb = function() {
                    ...
                    if (t.oa()) {
                        try {
                            (a = n.localStorage.getItem(t.ma())) && (e = n.JSON.parse(a))
                        } catch (e) {}
                        return e
                    }
                }
                ...
                ,
                t.U = function() {
                    if (!t.l || (t.v && t.v.complete && t.v.D && t.v.R(),
                    !t.l))
                        if (t.Na = a,
                        t.na)
                            t.ia > t.N && t.Ua(t.i),
                ...
                t.qa = function(e) {
                    t.Na || (e || (e = 0),
                    t.Na = setTimeout(t.U, e))
                }
                ,
                t.Cb = function() {
                    var e;
                    return !t.trackOffline || 0 >= t.offlineThrottleDelay ? 0 : (e = t.A() - t.Sa,
                ...
                t.Xb = function(e) {
                    ...
                    i = {
                        send: function(e) {
                            t.useBeacon = !1,
                            navigator.sendBeacon(e) ? i.R() : i.ga()
                        }
                    }),
                    !i && t.wa() && 2047 < e.length && (t.$a() && (r = 2,
                    i = new XMLHttpRequest),
                    i && (t.AudienceManagement && t.AudienceManagement.isReady() || 0 != t.usePostbacks) && (t.X ? i.Fa = !0 : i = 0)),
                    !i && t.Xa && (e = e.substring(0, 2047)),
                    ...
                    i.Ha = function() {
                        try {
                            i.D && (clearTimeout(i.D),
                            i.D = 0)
                        } catch (e) {}
                    }
                    ,
                    i.onload = i.R = function() {
                        if (i.Ta && (t.ja = Date.now() - i.Ta),
                        t.eb(e),
                        i.Ha(),
                        t.Gb(),
                        t.ca(),
                    ...
                    i.onabort = i.onerror = i.ga = function() {
                        i.Ha(),
                        (t.trackOffline || t.na) && t.l && t.i.unshift(t.Fb),
                        t.l = 0,
                        t.ia > t.N && t.Ua(t.i),
                        t.ca(),
                        t.qa(500)
                    ...
                    i.D = setTimeout(function() {
                        i.D && (i.complete ? i.R() : (t.trackOffline && i.abort && i.abort(),
                        i.ga()))
                    }, 5e3),
                    t.Fb = e,
                ...
                t.lb = function(e) {
                    var n = !1;
                    return navigator.sendBeacon && (t.nb(e) ? n = !0 : t.useBeacon && (n = !0)),
                    t.vb(e) && (n = !1),
                    n
                }
                ,
                ...
                t.Gb = function() {
                    if (t.oa() && !(t.Ra > t.N))
                        try {
                            n.localStorage.removeItem(t.ma()),
                            t.Ra = t.A()
                        } catch (e) {}
                }
                ,
                t.Ua = function(e) {
                    if (t.oa()) {
                        t.Wa();
                        try {
                            n.localStorage.setItem(t.ma(), n.JSON.stringify(e)),
                            t.N = t.A()
                        } catch (e) {}
                    }
                }
                ...
                t.g = t.F.concat("purchaseID variableProvider channel server pageType transactionID campaign state zip events events2 products audienceManagerBlob tnt".split(" ")),
                t.ka = "timestamp charSet visitorNamespace cookieDomainPeriods cookieLifetime contextData lightProfileID lightStoreForSeconds lightIncrementBy".split(" "),
                t.O = t.ka.slice(0),
                ...
                try {
                    ...
                    navigator) {
                        ...
                        ("Microsoft Internet Explorer" == navigator.appName || 0 <= s.indexOf("MSIE ") || 0 <= s.indexOf("Trident/") && 0 <= s.indexOf("Windows NT 6")) && (t.Xa = !0)
                    }
                } catch (e) {}
                t.ca = function() {
                    t.da && (n.clearTimeout(t.da),
                    t.da = a),
                ...
                t.Va = function() {
                        ...
                        if (!(t.d && t.d.getElementById("cppXYctnr") || e && e["s_fe_" + t._in])) {
                            if (t.Ga) {
                                if (!t.useForcedLinkTracking)
                                    ...
                                    void (t.Ga = t.useForcedLinkTracking = 0);
                            ...
                            try {
                                if (!t.clickObject || t.M && t.M == t.clickObject || !(t.clickObject.tagName || t.clickObject.parentElement || t.clickObject.parentNode))
                                    ...
                                    r = t.Ma(),
                                    t.track(),
                                    r < t.Ma() && t.useForcedLinkTracking && e.target) {
                    ...
                    ,
                    t.b && t.b.attachEvent ? t.b.attachEvent("onclick", t.r) : t.b && t.b.addEventListener && (navigator && (0 <= navigator.userAgent.indexOf("WebKit") && t.d.createEvent || 0 <= navigator.userAgent.indexOf("Firefox/2") && n.MouseEvent) && (t.Ga = 1,
                    t.useForcedLinkTracking = 1,
                    t.b.addEventListener("click", t.r, !0)),
                    t.b.addEventListener("click", t.r, !1))) : setTimeout(t.Va, 30)
                }
                ,
                t.Hb(),
                t.ic || (e ? t.setAccount(e) : t.C("Error, missing Report Suite ID in AppMeasurement initialization"),
                t.Va(),
    ...
    , {
        "./AppMeasurement/initialize": 71,
        "./AppMeasurement/plugins": 72
    }],
    ...
    , {
        ...
        "@marcom/ac-dom-nodes/NODE_TYPES": 19,
        "@marcom/ac-dom-nodes/isNodeType": 29
    }],
    ...
    , {
        "./helpers/globals": 76,
        "./touchAvailable": 80,
        "@marcom/function-utils/once": 82,
        "@marcom/useragent-detect": 86
    }],
            ...
            return _createClass(e, [{
                ...
                value: function() {
                    ...
                    !errorHandler.exception)) {
                        ...
                        var n = get([confKey, dlKeys.referrer]);
                        if (n || (n = urlHelpers.sanitizeUrl({
                            url: document.referrer,
                            pageType: this.conf[dlKeys.pageType],
                            isReferrerUrl: !0
                        })),
                        this._setConfigurationProperty(dlKeys.referrer, n || ""),
                        ...
                        !errorHandler.exception) {
                            ...
                            var o = this.conf.locale.toLowerCase();
                            this.formattedValues.countryCodeFilter = formatter.countryCodeFilter(o),
                            this.formattedValues.legacyCountryCode = formatter.legacyCountryCode(o),
                            this.formattedValues.pageName = formatter.pageName(this.conf.pageName, o),
                            this.formattedValues.channel = formatter.channel(this.conf.channel, o),
                ...
                value: function() {
                    ...
                    e.options.overrides && (n = e.options.overrides,
                ...
                key: "_getBucket",
                value: function(e, t) {
                    for (var r = constants.countryBuckets.length, a = 2, n = 0; n < r; n++)
                        if (-1 !== constants.countryBuckets[n].indexOf(t)) {
                            a = n;
                            break
                        }
                    var o = this._replaceTemplateVars(e["bucket" + a]);
                    if (o || errorHandler.log(moduleName, "bucket", "analytics-s-bucket-" + a + " metadata tag must exist"),
                    !errorHandler.exception) {
    ...
    , {
        ...
        "../constants": 136,
        "../helpers/cookie": 139,
        "../helpers/dataLayer": 140,
        "../helpers/eventsToString": 143,
        "../helpers/formatter": 145,
        "../helpers/generateSpecialExitLinks": 146,
        "../helpers/templateVar": 159,
        "../observers/observerRegistry": 170,
        "./appMeasurementPlugins": 88,
        "./doPlugins/doPlugins": 99,
        "./submit-methods/submitMethods": 130,
        "@apple/analytics-biscuit-tin": 1,
        "@apple/analytics-data-layer": 4,
        "@apple/analytics-utils": 10,
        "@marcom/appmeasurement-setup": 69
    }],
    ...
    , {
        "./appMeasurementPlugins/AppMeasurementTools": 89,
        "./appMeasurementPlugins/activitymap/ActivityMapCollection": 90,
        "./appMeasurementPlugins/activitymap/link": 92,
        "./appMeasurementPlugins/activitymap/region": 93,
        "./appMeasurementPlugins/getPercentPageViewed": 94,
        "./appMeasurementPlugins/getQueryParam": 95,
        "./appMeasurementPlugins/getValOnce": 96,
        "./appMeasurementPlugins/linkHandler": 97,
        "./appMeasurementPlugins/utilities/utilities": 98
    }],
    ...
    , {
        "./helpers/helpers.js": 91,
        "@marcom/ac-dom-traversal/ancestor": 42,
        "@marcom/ac-dom-traversal/isAncestorOf": 45
    }],
    ...
    92: [function(require, module, exports) {
        ...
        module.exports = function(e) {
            e.ActivityMap.link = function(t, i) {
                ...
                if ((!i || -1 === i.indexOf("v@e") && -1 === i.indexOf("v@sk") && -1 === i.indexOf("v@m")) && t && !t.hasAttribute("data-analytics-ignore-link"))
                    return (n = r(t)) ? -1 !== n.linkId.indexOf("/shop/goto/bag") ? "true" === n.element.getAttribute("aria-expanded") ? n.linkId + initialBagState : n.linkId + alteredBagState : n.linkId : (ActivityMapCollection.addElToCollection(t),
                    (n = r(t)) ? n.linkId : void 0)
            }
        }
    }
    , {
        "./ActivityMapCollection": 90,
        "@marcom/useragent-detect": 86
    }],
    ...
    , {
        "../../constants": 136,
        "../../helpers/isStorageAvailable": 151
    }],
    ...
    97: [function(require, module, exports) {
        ...
        module.exports = function(t) {
            t.p_gn = function(t, e) {
                ...
                return t && e && (n = i < 0 ? "" : t.substring(0, i),
                r = t.substring(i + 1),
                e.indexOf(r.toLowerCase()) > -1) ? n || "[[" : 0
            }
            ,
            t.p_gh = function() {
                var t = this;
                if (t.linkObject)
                    return t.linkObject.href;
                if (!t.eo && !t.lnk)
                    return "";
            ...
            ,
            t.pt = new Function("x","d","f","a","var s=this,t=x,z=0,y,r;while(t){y=t.indexOf(d);y=y<0?t.length:y;t=t.substring(0,y);r=s[f](t,a);if(r)return r;z+=y+d.length;t=x.substring(z,x.length);t=z<x.length?t:''}return'';"),
            t.linkHandler = function(t, e, n) {
                var r, i, o = this, s = o.p_gh(), u = s;
                return e = e || "o",
                !u || o.linkType && (u || o.linkName) ? "" : (r = u.indexOf("?"),
                u = o.linkLeaveQueryString || r < 0 ? u : u.substring(0, r),
                (i = o.pt(t, "|", "p_gn", u.toLowerCase())) ? (o.linkName = "[[" == i ? "" : i,
                o.linkType = e,
                n ? s : u) : "")
            }
        }
    ...
    98: [function(require, module, exports) {
        ...
        module.exports = function(t) {
            t.manageVars = function(t, e, n) {
                ...
                for (s = 1; s < 4; s++)
                    r += ",list" + s;
                for (s in o.contextData)
                    r += ",contextData." + s;
                if (!e || 1 != n && 2 != n)
                    return "" == e && 1 == n && (o.pt(r, ",", t, 0),
                    !0);
                if (1 == n && (r = e.replace("['", ".").replace("']", "")),
                2 == n) {
                    for (var f in a = e.split(","),
                    i = r.split(","),
                    r = "",
                    a)
                        if (a.hasOwnProperty(f))
                            for (var l in a[f].indexOf("contextData") > -1 && (lax = a[f].split("'"),
                            a[f] = "contextData." + lax[1]),
                            i)
                                a[f] == i[l] && (i[l] = "");
                    for (var l in i)
                        r += i[l] ? "," + i[l] : ""
            ...
            t.pt = function(t, e, n, r) {
                for (var a, i, o = t, s = 0; o; ) {
                    if (a = (a = o.indexOf(e)) < 0 ? o.length : a,
                    o = o.substring(0, a),
                    i = this[n](o, r))
                        return i;
                    s += a + e.length,
                    o = t.substring(s, t.length),
                    o = s < t.length ? o : ""
                }
                return ""
            }
            ,
            t.join = new Function("v","p","var s = this;var f,b,d,w;if(p){f=p.front?p.front:'';b=p.back?p.back:'';d=p.delim?p.delim:'';w=p.wrap?p.wrap:'';}var str='';for(var x=0;x<v.length;x++){if(typeof(v[x])=='object' )str+=s.join( v[x],p);else str+=w+v[x]+w;if(x<v.length-1)str+=d;}return f+str+b;"),
            t.apl = new Function("L","v","d","u","var s=this,m=0;if(!L)L='';if(u){var i,n,a=s.split(L,d);for(i=0;i<a.length;i++){n=a[i];m=m||(u==1?(n==v):(n.toLowerCase()==v.toLowerCase()));}}if(!m)L=L?L+d+v:v;return L"),
            t.split = new Function("l","d","var i,x=0,a=new Array;while(l){i=l.indexOf(d);i=i>-1?i:l.length;a[x++]=l.substring(0,i);l=l.substring(i+d.length);}return a")
        }
    }
    , {}],
    ...
    , {
        "./plugins/acAnalyticsVersion": 102,
        "./plugins/afid": 103,
        "./plugins/asPvi": 104,
        "./plugins/asTex": 105,
        "./plugins/beaconType": 106,
        "./plugins/clearLinkTracksAfterDownloadAndExit": 107,
        "./plugins/clickTimer": 108,
        "./plugins/enhanceDownloadLinks": 109,
        "./plugins/externalCampaign": 110,
        "./plugins/feedbackPage": 111,
        "./plugins/handleLink": 112,
        "./plugins/hierarchy1": 113,
        "./plugins/internalCampaign": 114,
        "./plugins/langLocale": 115,
        "./plugins/linkMissingTitle": 116,
        "./plugins/manageVars": 117,
        "./plugins/pageName": 118,
        "./plugins/passiveTracker": 119,
        "./plugins/percentPageViewed": 120,
        "./plugins/referrerAndCurrentUrl": 121,
        "./plugins/referrerQueryParam": 122,
        "./plugins/removeSpacesInLinkTrackVars": 123,
        "./plugins/retailCookies": 124,
        "./plugins/setTcallToFalse": 125,
        "./plugins/specialRssLinks": 126,
        "./plugins/targetResponse": 127,
        "./plugins/trackingState": 128,
        "./plugins/userSignInStatus": 129
    }],
    ...
    107: [function(require, module, exports) {
        ...
        function clearLinkTracksAfterDownloadAndExit(n) {
            "d" !== n.linkType && "e" !== n.linkType || (n.A = function(n) {
                n.linkTrackVars = "",
                n.linkTrackEvents = ""
            }
            .bind(null, n))
    ...
    , {
        "../../../constants": 136,
        "../../../helpers/mergeIntoDeferredBeacon": 152,
        "../../../passiveTracker": 171,
        "../helpers": 101,
        "@apple/analytics-data-layer": 4,
        "@apple/analytics-utils": 10
    ...
    109: [function(require, module, exports) {
        ...
        var appendList = require("../helpers").appendList
          ...
          , nameTrackingVar = "eVar11"
          , interactionTrackingProp = "prop16"
          , interactionTrackingVar = "eVar16";
        function enhanceDownloadLinks(n) {
            "d" === n.linkType && n.linkURL && (n.linkURL.match(/\.rss|\.xml/) ? n[interactionTrackingVar] = n[interactionTrackingProp] = "sign ups" : (n[nameTrackingVar] = "".concat(n.linkURL.substring(n.linkURL.lastIndexOf("/") + 1, n.linkURL.length)),
            n[interactionTrackingVar] = n[interactionTrackingProp] = "downloads",
            appendList(n, "events", downloadEvent),
            appendList(n, "linkTrackVars", [nameTrackingVar, "events"]),
    ...
    112: [function(require, module, exports) {
        ...
        function exitLinkAttribute(e) {
            "e" !== e.linkType && "d" !== e.linkType && e.linkObject.hasAttribute("data-analytics-exit-link") && (e.linkType = "e",
    ...
    , {
        "../../../constants": 136,
        "../../../helpers/parseFromDataAttribute": 155,
        "../../../passiveTracker": 171,
        "../helpers": 101,
        "@apple/analytics-data-layer": 4
    }],
    ...
    , {
        "../helpers": 101,
        "@marcom/appmeasurement-setup/src/appmeasurement-setup/AppMeasurementSetup": 73
    }],
    ...
    , {
        "../../../constants": 136,
        "../../../helpers/filterBeaconsByType": 144,
        "../../../helpers/getPassiveTrackerData": 147,
        "../../../helpers/mergePassiveTrackerData": 153,
        "../helpers": 101,
        "@apple/analytics-data-layer": 4,
        "@apple/analytics-merge-beacons": 5,
        "@apple/analytics-omniture-collection": 6
    }],
    ...
    , {
        "@marcom/ac-console/log": 13,
        "@marcom/ac-console/trace": 14
    }],
    ...
    , {
        "./Appmeasurement/AppMeasurement": 87,
        "./ErrorHandler": 133,
        "./Queue": 134,
        "./helpers/isEmptyObj": 148,
        "./helpers/mergeIntoDeferredBeacon": 152,
        "./helpers/templateVar": 159,
        "./passiveTracker": 171,
        "./trackers/TrackerRegistry": 172
    }],
    136: [function(require, module, exports) {
        "use strict";
        var dataLayerKeys = require("@apple/analytics-data-layer").KEYS
          , constants = {
            acAnalyticsVersion: "2.12.0",
    ...
    152: [function(require, module, exports) {
        ...
        var get = require("@apple/analytics-data-layer").get
          ...
          , mergeBeacons = require("@apple/analytics-merge-beacons").mergeBeacons
          , biscuitTin = require("@apple/analytics-biscuit-tin")
    ...
    , {
        "./dataStringToObject": 141,
        "./tokens/tokenReplacer": 161,
        "@marcom/ac-dom-nodes/isNode": 27
    }],
    ...
    162: [function(require, module, exports) {
        ...
        function setLegacySettings(e) {
            ...
            e.onPageDataLoadedOptions.page.sourceData = _objectSpread(_objectSpread({}, o), e.onPageDataLoadedOptions.page.sourceData),
            e
        }
    ...
    , {
        "./helpers/onDocumentReady": 154,
        "./observers/Click": 163,
        "./observers/Link": 166,
        "./observers/Page": 167,
        "./observers/Section": 168,
        "@marcom/ac-dom-nodes": 20
    }],
          ...
          , ClickAnalyticsObserver = function(e) {
            ...
            return _createClass(r, [{
                ...
                value: function(e) {
                    ...
                    r.classList.contains("ac-gn-link-bag") || "ac-gn-link-search" === r.id || "ac-gn-link-search-small" === r.id || r.hasAttribute("href") && "A" === r.tagName && !r.hasAttribute("data-analytics-intrapage-link") && exitLinkPattern.test(r.getAttribute("href")) || r.getAttribute("data-" + this.options.dataAttribute) && this.track(e, r)
                }
            }, {
                key: "track",
                value: function(e, t) {
    ...
    , {
        "../ErrorHandler": 133,
        "../Tracker": 135,
        "./observerRegistry": 170,
        "@marcom/ac-dom-nodes": 20,
        "@marcom/ac-event-emitter-micro": 60,
        "@marcom/dom-traversal/ancestor": 74
    }],
    ...
    , {
        ...
        "../Tracker": 135,
        "../helpers/DOM": 138,
        "../helpers/dynamicEventBinder": 142,
        "../helpers/onDocumentReady": 154,
        "./observerRegistry": 170,
        "@marcom/ac-event-emitter-micro": 60,
        "@marcom/dom-traversal/ancestor": 74
    ...
    , {
        "../ErrorHandler": 133,
        "../Tracker": 135,
        "../helpers/dataStringToObject": 141,
        "../helpers/isNumeric": 150,
        "./observerRegistry": 170,
        "@marcom/ac-element-engagement": 50,
        "@marcom/ac-event-emitter-micro": 60,
        "@marcom/function-utils/debounce": 81
    }],
          ...
          , VideoAnalyticsObserver = function() {
            ...
            return _createClass(e, [{
                ...
                value: function(e) {
                    ...
                    t.ttShowCount = this.ttShowCount,
                    this.track(t),
                    this.ttShowCount += 1
                }
            }, {
    ...
    , {
        ...
        "./observerRegistry": 170,
        "@marcom/ac-dom-nodes/isNode": 27,
        "@marcom/feature-detect/isHandheld": 78,
        "@marcom/function-utils/debounce": 81,
        "@marcom/useragent-detect": 86
    }],
    ...
    , {
        "./click": 173,
        "./customPageLoad": 174,
        "./deferredToPageLoad": 175,
        "./event": 176,
        "./gallery": 177,
        "./link": 178,
        "./navigationalLink": 179,
        "./pageHide": 180,
        "./pageLoad": 181,
        "./performance": 182,
        "./search/begin": 185,
        "./search/perform": 186,
        "./sectionEngagement": 187,
        "./storeDeferredBeaconAtPageLoad": 188,
        "./video": 189
    }],
    ...
    , {
        ...
        "../helpers/formatter": 145,
        "../helpers/parseFromDataAttribute": 155,
        "../helpers/separator": 156,
        "../helpers/setOptions": 157,
        "./TrackerRegistry": 172,
        "./regions/regions": 184,
        "@apple/analytics-data-layer": 4
    }],
    ...
    180: [function(require, module, exports) {
        ...
        var registry = require("./TrackerRegistry")
          ...
          , mergeBeacons = _require.mergeBeacons;
        function initialize() {
        ...
        function track(e) {
            ...
            e.beacon = mergeBeacons(e.beacon, r),
            remove(passiveTrackerPath),
            e) : e
        }
        module.exports = {
    ...
    181: [function(require, module, exports) {
        ...
        var registry = require("./TrackerRegistry")
          ...
          , confKeys = dataLayerKeys.configuration.keys
          , setProperty = require("../helpers/setProperty")
          , previousPage = require("@apple/analytics-bp-previous-page").previousPage;
        function initialize() {
        ...
        function track(e) {
            ...
            setProperty(e.beacon, "prop19", e.beacon.prop20 + separator.colon + e.beacon.pageName),
    ...
    , {
        ...
        "../helpers/setProperty": 158,
        "./TrackerRegistry": 172,
        "@apple/analytics-bp-previous-page": 2,
        "@apple/analytics-data-layer": 4
    }],
    ...
    185: [function(require, module, exports) {
        ...
        function track(e) {
            ...
            return a ? (mergeBeacons(e.beacon, getBeginBeacon(a)),
            e.beacon.title = e.beacon.prop3,
            e) : null
        }
        function getSearchObj(e) {
            if (!e.event || !config.trackEvents.includes(e.type))
                return null;
            var a = e.event.dynamicEventBinderTarget
              , n = get(pageTypeKey) === config.errorPage.pageType && a.id === config.errorPage.id
              , r = config.globalNavMobile === a.id;
            return n || r ? {
    ...
    186: [function(require, module, exports) {
        ...
        function track(e) {
            ...
            e.options.silent = !0,
            mergeBeacons(e.beacon, getPerformBeacon(r)),
            e) : null
        }
        function getSearchObj(e) {
            var r = e.type
        ...
        function clickLink(e) {
            var r = e.el;
            if (!r.classList.contains(config.globalNavLink))
                return null;
    ...
    187: [function(require, module, exports) {
        ...
        function track(e) {
            var a = e.data.element
              ...
              , n = ""
              , o = "";
            if (a.element && a.element.position && (n = a.element.position + separator.dot + separator.space,
            o = separator.space + separator.dot + a.element.position),
            e.beacon.prop34 = e.beacon.title = n + get([confKey, dataLayerConfig.keys.pageName]) + separator.hyphen + t + separator.hyphen + "section engaged" + o,
    ...
    188: [function(require, module, exports) {
        ...
        function track(e) {
            e.beacon.prop57 = {}.prop57 = get([dataLayerConfig.key, dataLayerConfig.keys.computedChannel]) || ""
        }
        module.exports = {
            track: track,
            initialize: initialize
    ...
    , {
        "./ac-analytics/Appmeasurement/appMeasurementPlugins/activitymap/ActivityMapCollection": 90,
        "./ac-analytics/ErrorHandler": 133,
        "./ac-analytics/Tracker": 135,
        "./ac-analytics/constants": 136,
        "./ac-analytics/destroy": 137,
        "./ac-analytics/initialize": 162,
        "./ac-analytics/observers/Click": 163,
        "./ac-analytics/observers/Event": 164,
        "./ac-analytics/observers/Gallery": 165,
        "./ac-analytics/observers/Link": 166,
        "./ac-analytics/observers/Page": 167,
        "./ac-analytics/observers/Section": 168,
        "./ac-analytics/observers/Video": 169,
        "./ac-analytics/observers/observerRegistry": 170,
        "./ac-analytics/passiveTracker": 171,
        "./ac-analytics/trackers/performance": 182,
        "./ac-analytics/trackers/regions/regions": 184,
        "@apple/analytics-data-layer": 4
    }],
